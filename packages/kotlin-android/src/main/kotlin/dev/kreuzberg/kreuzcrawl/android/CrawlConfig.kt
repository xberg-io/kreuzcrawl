...
data class CrawlConfig(
     ...
     *
     * Skipped from polyglot binding generation (`#[cfg_attr(alef, alef(skip))]`). Per-request
     * override from language clients is unsupported in v1 — the policy is set at config-load (env +
     * builder) from the Rust side.
     */
    val ssrf: String? = null,
    /**
