...
data class CrawlConfig(
     ...
     *
     * Rust-only advanced field. Generated language bindings do not expose per-request SSRF policy
     * overrides; they use the policy assembled from environment defaults and server-side Rust
     * configuration.
     */
