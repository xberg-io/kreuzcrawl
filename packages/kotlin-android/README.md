...
JVM consumers should use the canonical `dev.kreuzberg.kreuzcrawl:kreuzcrawl` artifact directly.
...
```bash
implementation("dev.kreuzberg.kreuzcrawl:kreuzcrawl-android:0.3.0-rc.80")
