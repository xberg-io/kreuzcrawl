...
// alef:hash:2b37b982f4d1ecfc9773b062f977cc0cc2c9d5b6370c2b7f648a3dee88dbac39
...
// WithBrowserConfigBackend sets the backend field.
func WithBrowserConfigBackend(v BrowserBackend) BrowserConfigOption {
	return func(c *BrowserConfig) { c.Backend = &v }
}
...
// WithBrowserConfigStealth sets the stealth field.
func WithBrowserConfigStealth(v bool) BrowserConfigOption {
	return func(c *BrowserConfig) { c.Stealth = v }
}

// WithBrowserConfigProxy sets the proxy field.
func WithBrowserConfigProxy(v ProxyConfig) BrowserConfigOption {
	return func(c *BrowserConfig) { c.Proxy = &v }
}

// WithBrowserConfigBlockURLPatterns sets the block_url_patterns field.
func WithBrowserConfigBlockURLPatterns(v []string) BrowserConfigOption {
	return func(c *BrowserConfig) { c.BlockURLPatterns = v }
}

// WithBrowserConfigEvalScript sets the eval_script field.
func WithBrowserConfigEvalScript(v string) BrowserConfigOption {
	return func(c *BrowserConfig) { c.EvalScript = &v }
}

// WithBrowserConfigRobotsUserAgent sets the robots_user_agent field.
func WithBrowserConfigRobotsUserAgent(v string) BrowserConfigOption {
	return func(c *BrowserConfig) { c.RobotsUserAgent = &v }
}

// WithBrowserConfigCaptureNetworkEvents sets the capture_network_events field.
func WithBrowserConfigCaptureNetworkEvents(v bool) BrowserConfigOption {
	return func(c *BrowserConfig) { c.CaptureNetworkEvents = v }
}
