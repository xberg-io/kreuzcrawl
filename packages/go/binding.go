...
#cgo darwin,arm64 LDFLAGS: -L${SRCDIR}/.lib/macos-arm64 -lkreuzcrawl_ffi
#cgo darwin,amd64 LDFLAGS: -L${SRCDIR}/.lib/macos-amd64 -lkreuzcrawl_ffi
#cgo linux,amd64 LDFLAGS: -L${SRCDIR}/.lib/linux-amd64 -lkreuzcrawl_ffi
#cgo linux,arm64 LDFLAGS: -L${SRCDIR}/.lib/linux-arm64 -lkreuzcrawl_ffi
