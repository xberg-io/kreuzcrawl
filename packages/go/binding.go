...
// alef:hash:550c0567e3869d965432dac4d00d8e2dc377822d8c4e121b58105e4400357758
// To regenerate: alef generate
// To verify freshness: alef verify --exit-code
// Issues & docs: https://github.com/kreuzberg-dev/alef

// Package kreuzcrawl provides Go bindings for the liter-llm library.
package kreuzcrawl
...
const (
	// BrowserModeAuto automatically detect when JS rendering is needed and fall back to browser.
	BrowserModeAuto BrowserMode = "auto"
	// BrowserModeAlways always use the browser for every request.
	BrowserModeAlways BrowserMode = "always"
	// BrowserModeNever never use the browser fallback.
...
const (
	// BrowserWaitNetworkIdle wait until network activity is idle.
	BrowserWaitNetworkIdle BrowserWait = "network_idle"
	// BrowserWaitSelector wait for a specific CSS selector to appear in the DOM.
	BrowserWaitSelector BrowserWait = "selector"
	// BrowserWaitFixed wait for a fixed duration after navigation.
...
// LinkType classification of a link.
type LinkType string

const (
	// LinkTypeInternal a link to the same domain.
	LinkTypeInternal LinkType = "internal"
	// LinkTypeExternal a link to a different domain.
	LinkTypeExternal LinkType = "external"
	// LinkTypeAnchor a fragment-only link (e.g., `#section`).
	LinkTypeAnchor LinkType = "anchor"
	// LinkTypeDocument a link to a downloadable document (PDF, DOC, etc.).
	LinkTypeDocument LinkType = "document"
)

// ImageSource source of an image reference.
type ImageSource string

const (
	// ImageSourceImg an `<img>` tag.
	ImageSourceImg ImageSource = "img"
	// ImageSourcePictureSource a `<source>` tag inside `<picture>`.
	ImageSourcePictureSource ImageSource = "picture_source"
	// ImageSourceOgImage an `og:image` meta tag.
	ImageSourceOgImage ImageSource = "og:image"
	// ImageSourceTwitterImage a `twitter:image` meta tag.
	ImageSourceTwitterImage ImageSource = "twitter:image"
)

// FeedType type of a feed (RSS, Atom, or JSON Feed).
type FeedType string

const (
	// FeedTypeRss rSS feed.
	FeedTypeRss FeedType = "rss"
	// FeedTypeAtom atom feed.
	FeedTypeAtom FeedType = "atom"
	// FeedTypeJSONFeed jSON Feed.
	FeedTypeJSONFeed FeedType = "json_feed"
)

// AssetCategory category of a downloaded asset.
type AssetCategory string

const (
	// AssetCategoryDocument a document file (PDF, DOC, etc.).
	AssetCategoryDocument AssetCategory = "document"
	// AssetCategoryImage an image file.
	AssetCategoryImage AssetCategory = "image"
	// AssetCategoryAudio an audio file.
	AssetCategoryAudio AssetCategory = "audio"
	// AssetCategoryVideo a video file.
	AssetCategoryVideo AssetCategory = "video"
	// AssetCategoryFont a font file.
	AssetCategoryFont AssetCategory = "font"
	// AssetCategoryStylesheet a CSS stylesheet.
	AssetCategoryStylesheet AssetCategory = "stylesheet"
	// AssetCategoryScript a JavaScript file.
	AssetCategoryScript AssetCategory = "script"
	// AssetCategoryArchive an archive file (ZIP, TAR, etc.).
	AssetCategoryArchive AssetCategory = "archive"
	// AssetCategoryData a data file (JSON, XML, CSV, etc.).
	AssetCategoryData AssetCategory = "data"
	// AssetCategoryOther an unrecognized asset type.
