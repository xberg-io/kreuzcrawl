...
// alef:hash:69e1d697a7ac4f028923f9a24828c3c9ff5660d6f5925d9b2ac275aab278b506
...
// Default is a method.
func ContentConfigDefault() *ContentConfig {
	ptr := C.kcrawl_content_config_default()
	defer C.kcrawl_content_config_free(ptr)
	return func() *ContentConfig {
		jsonPtr := C.kcrawl_content_config_to_json(ptr)
		if jsonPtr == nil {
			return nil
		}
		defer C.kcrawl_free_string(jsonPtr)
...
// Default is a method.
func BrowserConfigDefault() *BrowserConfig {
	ptr := C.kcrawl_browser_config_default()
	defer C.kcrawl_browser_config_free(ptr)
	return func() *BrowserConfig {
		jsonPtr := C.kcrawl_browser_config_to_json(ptr)
		if jsonPtr == nil {
			return nil
		}
		defer C.kcrawl_free_string(jsonPtr)
		var result BrowserConfig
		if err := json.Unmarshal([]byte(C.GoString(jsonPtr)), &result); err != nil {
			return nil
		}
		return &result
...
// Default is a method.
func CrawlConfigDefault() *CrawlConfig {
	ptr := C.kcrawl_crawl_config_default()
	defer C.kcrawl_crawl_config_free(ptr)
	return func() *CrawlConfig {
		jsonPtr := C.kcrawl_crawl_config_to_json(ptr)
		if jsonPtr == nil {
			return nil
		}
		defer C.kcrawl_free_string(jsonPtr)
