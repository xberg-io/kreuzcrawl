...
// alef:hash:28f64dca66b8496ce392dc7ea50ad0c81f4a30eb2fcd0d5a006c645dc72b79e1
...
pub fn batch_scrape_async(
    ...
    Err(String::from("Not implemented: batch_scrape_async"))
}

/// Crawl multiple seed URLs concurrently, each following links to configured depth.
#[rustler::nif(schedule = "DirtyCpu")]
pub fn batch_crawl_async(engine: rustler::ResourceArc<CrawlEngineHandle>, urls: Vec<String>) -> Result<String, String> {
    Err(String::from("Not implemented: batch_crawl_async"))
}
