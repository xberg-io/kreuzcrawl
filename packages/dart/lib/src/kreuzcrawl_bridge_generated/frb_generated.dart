...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  /// 3. Package-installed location (lib/src/kreuzcrawl_bridge_generated/)
    ...
    try {
      ...
      if (rid != null) {
        final packageRoot = await Isolate.resolvePackageUri(
          _DartCore.Uri.parse('package:kreuzcrawl/kreuzcrawl.dart'),
        );
        if (packageRoot != null) {
      ...
      if (packageRoot != null) {
        final libDir = packageRoot.resolve('src/kreuzcrawl_bridge_generated/');
        for (final candidate in candidates) {
