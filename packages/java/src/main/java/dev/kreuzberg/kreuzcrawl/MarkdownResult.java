...
// alef:hash:96d0b90e0306f1f90735dc61f9840d2aab573ebc82fe4a6feefd0348e79ff400
...
public record MarkdownResult(String content, @Nullable @JsonProperty("document_structure") Object documentStructure,
		...
		@JsonInclude(JsonInclude.Include.NON_NULL) List<String> warnings, @Nullable CitationResult citations,
