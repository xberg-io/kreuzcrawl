...
// alef:hash:0884d1f85a91c7c4675b85ef2bfd6577ff8b6949ecab91fd39f6c0b60d055e53
...
public class DownloadedAssetBuilder {
	...
	public DownloadedAsset build() {
		return new DownloadedAsset(url, contentHash, mimeType.orElse(null), size, assetCategory, htmlTag.orElse(null));
	}
}
