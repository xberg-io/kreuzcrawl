...
// alef:hash:7c2fc55e18f38bcbc26e18a66ac79a41dfd050a04f6d810e10e28baea0963bf5
...
public final class KreuzcrawlRs {
     ...
     */
    public static String batchScrape(final CrawlEngineHandle engine, final List<String> urls) throws KreuzcrawlRsException {
        try (var arena = Arena.ofShared()) {
            var cengine = engine.handle();
    ...
    public static CompletableFuture<String> batchScrapeAsync(final CrawlEngineHandle engine, final List<String> urls) {
        return CompletableFuture.supplyAsync(() -> {
            try {
     ...
     */
    public static String batchCrawl(final CrawlEngineHandle engine, final List<String> urls) throws KreuzcrawlRsException {
        try (var arena = Arena.ofShared()) {
            var cengine = engine.handle();
            var curlsJson = MAPPER.writeValueAsString(urls);
            var curls = arena.allocateFrom(curlsJson);
    ...
    public static CompletableFuture<String> batchCrawlAsync(final CrawlEngineHandle engine, final List<String> urls) {
        return CompletableFuture.supplyAsync(() -> {
            try {
