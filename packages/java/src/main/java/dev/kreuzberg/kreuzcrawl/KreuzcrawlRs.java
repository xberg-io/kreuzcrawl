...
// alef:hash:ce3ebd1838aa2ecbd9f21731213522b710e7f91da613008a2dbf9a64119066d5
...
public final class KreuzcrawlRs {
	...
	private static <T> java.util.List<T> readJsonList(MemorySegment resultPtr,
			com.fasterxml.jackson.core.type.TypeReference<java.util.List<T>> typeRef) throws KreuzcrawlRsException {
		try {
			if (resultPtr.equals(MemorySegment.NULL)) {
				checkLastError();
