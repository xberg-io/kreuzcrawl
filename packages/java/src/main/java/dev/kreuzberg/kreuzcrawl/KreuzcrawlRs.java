...
// alef:hash:b501ea94a1c0dadcb42ac03bdcce07d9b72a13fd5d3e5b46a7876be3bcd090d9
...
public final class KreuzcrawlRs {
    ...
    public static List<BatchScrapeResult> batchScrape(final CrawlEngineHandle engine, final List<String> urls) throws KreuzcrawlRsException {
        try (var arena = Arena.ofConfined()) {
            var cengine = engine.handle();
    ...
    private static <T> java.util.List<T> readJsonList(MemorySegment resultPtr, com.fasterxml.jackson.core.type.TypeReference<java.util.List<T>> typeRef) throws KreuzcrawlRsException {
        try {
            if (resultPtr.equals(MemorySegment.NULL)) {
                checkLastError();
