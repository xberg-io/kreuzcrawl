...
# alef:hash:a63ea8ca8c3871698fe79e44a0010f16fd105204f57245d7503164d223daeecf
...
async def batch_scrape(engine: CrawlEngineHandle, urls: list[str]) -> str:
    """Scrape multiple URLs concurrently."""
    return await _rust.batch_scrape(engine=engine, urls=urls)


async def batch_crawl(engine: CrawlEngineHandle, urls: list[str]) -> str:
