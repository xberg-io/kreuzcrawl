...
# alef:hash:c50e08950cb3a465c2f71cc3fc313ec4d10dd0c6ae933596fef4ed774374cc9a
...
AssetCategory.DOCUMENT = AssetCategory.Document

AssetCategory.IMAGE = AssetCategory.Image

AssetCategory.AUDIO = AssetCategory.Audio

AssetCategory.VIDEO = AssetCategory.Video

AssetCategory.FONT = AssetCategory.Font

AssetCategory.STYLESHEET = AssetCategory.Stylesheet

AssetCategory.SCRIPT = AssetCategory.Script

AssetCategory.ARCHIVE = AssetCategory.Archive

AssetCategory.DATA = AssetCategory.Data

AssetCategory.OTHER = AssetCategory.Other


BrowserMode.AUTO = BrowserMode.Auto

BrowserMode.ALWAYS = BrowserMode.Always

BrowserMode.NEVER = BrowserMode.Never


BrowserWait.NETWORK_IDLE = BrowserWait.NetworkIdle

BrowserWait.SELECTOR = BrowserWait.Selector

BrowserWait.FIXED = BrowserWait.Fixed
...
FeedType.JSON_FEED = FeedType.JsonFeed


ImageSource.IMG = ImageSource.Img

ImageSource.PICTURE_SOURCE = ImageSource.PictureSource

ImageSource.OG_IMAGE = ImageSource.OgImage

ImageSource.TWITTER_IMAGE = ImageSource.TwitterImage
