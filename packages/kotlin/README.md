...
<div align="center" style="display: flex; flex-wrap: wrap; gap: 8px; justify-content: center; margin: 20px 0;">
  ...
  <a href="https://pkg.go.dev/github.com/kreuzberg-dev/kreuzcrawl/packages/go">
    <img src="https://img.shields.io/github/v/tag/kreuzberg-dev/kreuzcrawl?label=Go&color=007ec6&filter=v0.3.0-rc.19" alt="Go">
  </a>
...
Kotlin/JVM bindings for **kreuzcrawl** — a high-performance Rust web crawling engine.
Idiomatic Kotlin wrapper over the Java Panama FFM facade, with data classes and coroutines.

## Installation

```bash
implementation("dev.kreuzberg.kreuzcrawl:kreuzcrawl-kotlin:0.3.0-rc.19")
```
