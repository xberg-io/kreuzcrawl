...
// alef:hash:a63f55358c98115f1b74d0c2471d94d7d4b93c211b30e7ebc22a2bf60d2ff5fa
...
#[derive(Clone, Debug, serde::Serialize, serde::Deserialize)]
#[serde(default)]
#[magnus::wrap(class = "Kreuzcrawl::BrowserExtras")]
...
impl Default for BrowserExtras {
    fn default() -> Self {
        kreuzcrawl::BrowserExtras::default().into()
    }
}
...
impl Default for InteractionResult {
    fn default() -> Self {
        kreuzcrawl::InteractionResult::default().into()
    }
}
...
impl Default for ActionResult {
    fn default() -> Self {
        kreuzcrawl::ActionResult::default().into()
    }
}
...
#[derive(Clone, Debug, serde::Serialize, serde::Deserialize)]
#[serde(default)]
#[magnus::wrap(class = "Kreuzcrawl::CrawlStreamRequest")]
...
impl Default for CrawlStreamRequest {
    fn default() -> Self {
        kreuzcrawl::CrawlStreamRequest::default().into()
    }
}
...
#[derive(Clone, Debug, serde::Serialize, serde::Deserialize)]
#[serde(default)]
#[magnus::wrap(class = "Kreuzcrawl::BatchCrawlStreamRequest")]
...
impl Default for BatchCrawlStreamRequest {
    fn default() -> Self {
        kreuzcrawl::BatchCrawlStreamRequest::default().into()
    }
}
...
#[derive(Clone, Debug, serde::Serialize, serde::Deserialize)]
#[serde(default)]
#[magnus::wrap(class = "Kreuzcrawl::BatchScrapeResults")]
...
impl Default for BatchScrapeResults {
    fn default() -> Self {
        kreuzcrawl::BatchScrapeResults::default().into()
    }
}
...
#[derive(Clone, Debug, serde::Serialize, serde::Deserialize)]
#[serde(default)]
#[magnus::wrap(class = "Kreuzcrawl::BatchCrawlResults")]
...
impl Default for BatchCrawlResults {
    fn default() -> Self {
        kreuzcrawl::BatchCrawlResults::default().into()
    }
}
...
fn interact(engine: CrawlEngineHandle, url: String, actions: Vec<PageAction>) -> Result<InteractionResult, Error> {
    ...
    let result = rt
        .block_on(async { kreuzcrawl::interact(&engine.inner, &url, actions_core).await })
        .map_err(|e| {
            magnus::Error::new(
                unsafe { Ruby::get_unchecked() }.exception_runtime_error(),
                e.to_string(),
...
impl From<kreuzcrawl::CrawlEvent> for CrawlEvent {
    fn from(val: kreuzcrawl::CrawlEvent) -> Self {
        match val {
            kreuzcrawl::CrawlEvent::Page { result } => Self::Page {
                result: (*result).into(),
            },
...
impl From<kreuzcrawl::PageAction> for PageAction {
    fn from(val: kreuzcrawl::PageAction) -> Self {
        match val {
            kreuzcrawl::PageAction::Click { selector } => Self::Click { selector },
            kreuzcrawl::PageAction::TypeText { selector, text } => Self::TypeText { selector, text },
            kreuzcrawl::PageAction::Press { key } => Self::Press { key },
            ...
            kreuzcrawl::PageAction::Wait { milliseconds, selector } => Self::Wait { milliseconds, selector },
            kreuzcrawl::PageAction::Screenshot { full_page } => Self::Screenshot { full_page },
            kreuzcrawl::PageAction::ExecuteJs { script } => Self::ExecuteJs { script },
        ...
        tokio::sync::Mutex<
            Option<
                futures::stream::BoxStream<
                    'static,
                    std::result::Result<kreuzcrawl::CrawlEvent, kreuzcrawl::CrawlError>,
                >,
            >,
        >,
    >,
...
#[derive(Clone)]
#[magnus::wrap(class = "Kreuzcrawl::BatchCrawlStreamIterator")]
...
fn ruby_init(ruby: &Ruby) -> Result<(), Error> {
    ...
    class.define_method("bypass", method!(CrawlConfig::bypass, 0))?;
