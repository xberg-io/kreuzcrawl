...
impl From<kreuzcrawl::AuthConfig> for AuthConfig {
    fn from(val: kreuzcrawl::AuthConfig) -> Self {
        match val {
            ...
            kreuzcrawl::AuthConfig::Bearer { token } => Self::Bearer {
...
impl From<kreuzcrawl::PageAction> for PageAction {
    fn from(val: kreuzcrawl::PageAction) -> Self {
        match val {
            kreuzcrawl::PageAction::Click { selector } => Self::Click {
                selector: selector.to_string(),
            },
            kreuzcrawl::PageAction::TypeText { selector, text } => Self::TypeText {
                selector: selector.to_string(),
                text: text.to_string(),
            },
            kreuzcrawl::PageAction::Press { key } => Self::Press { key: key.to_string() },
            ...
            kreuzcrawl::PageAction::Wait { milliseconds, selector } => Self::Wait {
                milliseconds,
                selector: selector.map(|v| v.to_string()),
            },
            kreuzcrawl::PageAction::Screenshot { full_page } => Self::Screenshot { full_page },
            kreuzcrawl::PageAction::ExecuteJs { script } => Self::ExecuteJs {
