...
// alef:hash:dc5451b50b662ca8398a5e8316b2cbe8704f6b4ed2a8880b38685a476a3fd893
...
fn batch_scrape(engine: CrawlEngineHandle, urls: Vec<String>) -> Result<String, Error> {
    let rt = tokio::runtime::Runtime::new().map_err(|e| {
        magnus::Error::new(
            unsafe { Ruby::get_unchecked() }.exception_runtime_error(),
            e.to_string(),
...
fn batch_scrape_async(engine: CrawlEngineHandle, urls: Vec<String>) -> Result<String, Error> {
    let rt = tokio::runtime::Runtime::new().map_err(|e| {
        magnus::Error::new(
            unsafe { Ruby::get_unchecked() }.exception_runtime_error(),
            e.to_string(),
...
fn batch_crawl(engine: CrawlEngineHandle, urls: Vec<String>) -> Result<String, Error> {
    let rt = tokio::runtime::Runtime::new().map_err(|e| {
        magnus::Error::new(
            unsafe { Ruby::get_unchecked() }.exception_runtime_error(),
            e.to_string(),
...
fn batch_crawl_async(engine: CrawlEngineHandle, urls: Vec<String>) -> Result<String, Error> {
    let rt = tokio::runtime::Runtime::new().map_err(|e| {
        magnus::Error::new(
            unsafe { Ruby::get_unchecked() }.exception_runtime_error(),
            e.to_string(),
