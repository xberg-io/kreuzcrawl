    ...
    public static CrawlPageResult FromJson(string json)
    {
        try
        {
            return JsonSerializer.Deserialize<CrawlPageResult>(json, JsonOptions)
                ?? throw new KreuzcrawlException($"Failed to parse CrawlPageResult from JSON: deserializer returned null");
        }
        ...
        {
            throw new KreuzcrawlException($"Failed to parse CrawlPageResult from JSON: {e.Message}", e);
        }
    }
