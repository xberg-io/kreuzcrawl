...
// alef:hash:f229440e1fa5c09ee218115dc38fdbc764f1efe442ae3db4d8d573a6122c4eaf
...
public sealed class AuthConfigJsonConverter : JsonConverter<AuthConfig>
{
    public override AuthConfig Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        ...
        // Deserialize the variant from the flattened JSON (excluding the "type" discriminator).
        // Don't wrap under "Value" — the records have fields directly, not wrapped.
