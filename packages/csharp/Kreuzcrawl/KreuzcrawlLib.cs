...
// alef:hash:17b3e94b23b83074d2e94644aeb486ecef5e707a02ead7ad84b13853b2072d05
#nullable enable
...
public static class KreuzcrawlLib
{
    ...
    private static Exception GetLastError()
    {
        ...
        var ctxPtr = NativeMethods.LastErrorContext();
        var message = Marshal.PtrToStringUTF8(ctxPtr) ?? "Unknown error";        if (code == 2) return new CrawlErrorException(message);        return new KreuzcrawlException(code, message);
    }
}
