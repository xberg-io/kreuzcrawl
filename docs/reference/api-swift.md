...
## Swift API Reference <span class="version-badge">v0.3.0-rc.70</span>
...
```swift
let result = try instance.crawlStream(CrawlStreamRequest())
```
...
```swift
let result = try instance.batchCrawlStream(BatchCrawlStreamRequest())
```
