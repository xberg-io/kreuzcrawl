...
## WebAssembly API Reference <span class="version-badge">v0.3.0-rc.20</span>
...
function batchScrape(
  ...
  urls: Array<string>,
): Promise<Array<BatchScrapeResult>>;
```
...
function batchCrawl(
  engine: CrawlEngineHandle,
  urls: Array<string>,
): Promise<Array<BatchCrawlResult>>;
```
...
| `evalScript`           | `string \| null`      | `null`                         | JavaScript snippet evaluated after navigation completes. Result is captured in `ScrapeResult.browser.eval_result`. Native only.                                                                             |
