...
## Java API Reference <span class="version-badge">v0.3.0-rc.70</span>
...
```java
var result = instance.crawlStream(new CrawlStreamRequest());
```
...
```java
var result = instance.batchCrawlStream(new BatchCrawlStreamRequest());
```
