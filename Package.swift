...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/kreuzberg-dev/kreuzcrawl/releases/download/v0.3.0-rc.84/Kreuzcrawl-rs.artifactbundle.zip",
      checksum: "fb7ed8a588f146362d220079b966b2d65c6da31bd4dc93c37c0cfa3f80719b67"
    ),
