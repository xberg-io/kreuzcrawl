...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/xberg-io/crawlberg/releases/download/v1.0.0-rc.1/Crawlberg-rs.artifactbundle.zip",
      checksum: "bd2eeee24d60f018ac536f95204ebb876377b9186b1921f7af4e981558081e9e"
    ),
