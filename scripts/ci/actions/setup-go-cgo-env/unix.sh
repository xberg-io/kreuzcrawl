...
pkg_config_path="${repo_root}/crates/kreuzcrawl-ffi:${PKG_CONFIG_PATH:-}"
...
cgo_enabled=1
cgo_cflags="-I${repo_root}/crates/kreuzcrawl-ffi/include"
cgo_ldflags="-L${ffi_path} -lkreuzcrawl_ffi"
