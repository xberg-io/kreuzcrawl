...
$pkgConfigDir = "$msys2RepoRoot/crates/kreuzcrawl-ffi"
...
$headerPath = Join-Path $repoRoot "packages/go/v4/internal/ffi\kreuzcrawl.h"
if (-not (Test-Path $headerPath)) {
  ...
  Write-Host "  Expected: packages/go/v4/internal/ffi/kreuzcrawl.h"
} else {
  Write-Host "✓ FFI header verified at packages/go/v4/internal/ffi/kreuzcrawl.h"
}
...
$importLibName = "libkreuzcrawl_ffi.dll.a"
...
# See: https://github.com/kreuzcrawl-dev/kreuzcrawl/pull/316
$linkerVerboseFlags = ""
...
# already specify -lkreuzcrawl_ffi and Windows system libraries (-lws2_32, etc)
