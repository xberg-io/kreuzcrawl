...
pub async fn crawl_stream(engine: &JsCrawlEngineHandle, url: String) -> Result<CrawlStreamIterator> {
    let core_crawl_stream_request: kreuzcrawl::CrawlStreamRequest = JsCrawlStreamRequest { url: Some(url) }.into();
...
pub async fn batch_crawl_stream(engine: &JsCrawlEngineHandle, urls: Vec<String>) -> Result<BatchCrawlStreamIterator> {
    let core_batch_crawl_stream_request: kreuzcrawl::BatchCrawlStreamRequest =
...
#[allow(clippy::field_reassign_with_default, clippy::let_and_return)]
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsSsrfPolicy> for kreuzcrawl::SsrfPolicy {
    fn from(val: JsSsrfPolicy) -> Self {
        let mut __result = kreuzcrawl::SsrfPolicy::default();
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzcrawl::SsrfPolicy> for JsSsrfPolicy {
...
/// Convert a `kreuzcrawl::SsrfError` error to a NAPI error.
#[allow(dead_code)]
fn ssrf_error_to_napi_err(e: kreuzcrawl::SsrfError) -> napi::Error {
    let msg = e.to_string();
    #[allow(unreachable_patterns)]
    match &e {
