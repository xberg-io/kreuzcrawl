...
// alef:hash:3824a5793c8b1b84ad8d9d33f76e24c770419938e95abc5950dfaac5f26fafa4
...
pub async fn crawl_stream(engine: &JsCrawlEngineHandle, url: String) -> Result<CrawlStreamIterator> {
    let core_crawl_stream_request: kreuzcrawl::CrawlStreamRequest = JsCrawlStreamRequest {
        url: Some(url),
        ..Default::default()
    }
    .into();
...
pub async fn batch_crawl_stream(engine: &JsCrawlEngineHandle, urls: Vec<String>) -> Result<BatchCrawlStreamIterator> {
    let core_batch_crawl_stream_request: kreuzcrawl::BatchCrawlStreamRequest = JsBatchCrawlStreamRequest {
        urls: Some(urls),
        ..Default::default()
    }
    .into();
...
impl From<JsBrowserConfig> for kreuzcrawl::BrowserConfig {
    fn from(val: JsBrowserConfig) -> Self {
        ...
        if let Some(__v) = val.stealth {
            __result.stealth = __v;
        }
