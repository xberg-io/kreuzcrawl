...
// alef:hash:8cc5b25c87c55853af9f11e4f951ad6459ddadf4a7fb73c786fbda1bea42184a
...
impl Clone for JsDownloadedDocument {
    fn clone(&self) -> Self {
        Self {
            url: self.url.clone(),
            mime_type: self.mime_type.clone(),
            content: self.content.as_ref().map(|b| b.to_vec().into()),
...
impl Clone for JsScrapeResult {
    fn clone(&self) -> Self {
        Self {
            ...
            is_allowed: self.is_allowed.clone(),
            crawl_delay: self.crawl_delay.clone(),
            noindex_detected: self.noindex_detected.clone(),
            nofollow_detected: self.nofollow_detected.clone(),
            x_robots_tag: self.x_robots_tag.clone(),
            is_pdf: self.is_pdf.clone(),
            was_skipped: self.was_skipped.clone(),
            detected_charset: self.detected_charset.clone(),
            auth_header_sent: self.auth_header_sent.clone(),
            response_meta: self.response_meta.clone(),
            assets: self.assets.clone(),
            js_render_hint: self.js_render_hint.clone(),
            browser_used: self.browser_used.clone(),
            markdown: self.markdown.clone(),
            extracted_data: self.extracted_data.clone(),
            extraction_meta: self.extraction_meta.clone(),
            screenshot: self.screenshot.as_ref().map(|b| b.to_vec().into()),
            downloaded_document: self.downloaded_document.clone(),
        }
    }
}
