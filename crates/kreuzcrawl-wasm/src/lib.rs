...
// alef:hash:119128d5b1fb2f1974a6205549198e5e3f563b30747969d18c6028fa61169e63
...
pub async fn batch_scrape(engine: WasmCrawlEngineHandle, urls: Vec<String>) -> Result<String, JsValue> {
...
pub async fn batch_crawl(engine: WasmCrawlEngineHandle, urls: Vec<String>) -> Result<String, JsValue> {
