// Portions derived from Obscura.
// Source: https://github.com/h4ckf0r0day/obscura
// Source commit: e371e942fc894578283b00690e34943fe1e45c7e
// License: Apache-2.0
// Modifications: disabled unaudited tracker-domain data.

use std::collections::HashSet;
use std::sync::OnceLock;

// The upstream Obscura checkout includes `pgl_domains.txt`, but that data file
// has no visible provenance or license header in the local source. Kreuzcrawl
// does not enable tracker blocking in the vendored backend yet, so keep this
// list empty until the data source can be audited and attributed.
const PGL_LIST: &str = "";
