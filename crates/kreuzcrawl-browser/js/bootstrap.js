...
globalThis.onerror = function (msg, src, line, col, error) {
	globalThis.__kreuzcrawl_errors.push({
		msg: String(msg),
		src: String(src || ""),
		line,
		error: String(error || ""),
...
class Element extends Node {
	...
	focus() {
		globalThis.__kreuzcrawl_focused = this;
		globalThis.__kreuzcrawl_click_target = this;
	}
	blur() {
		if (globalThis.__kreuzcrawl_focused === this) globalThis.__kreuzcrawl_focused = null;
	}
	get value() {
...
class Document extends Node {
	...
	get activeElement() {
		return globalThis.__kreuzcrawl_focused || this.body;
	}
	get implementation() {
		return {
...
globalThis.__kreuzcrawl_init = function () {
	...
	const toHide = Object.keys(globalThis).filter(
		(k) => k.startsWith("_") || k.includes("kreuzcrawl") || k.includes("Kreuzcrawl"),
	);
