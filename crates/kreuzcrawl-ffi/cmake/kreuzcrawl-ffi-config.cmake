...
if(NOT _FFI_LIBRARY)
  find_library(_FFI_LIBRARY NAMES kreuzcrawl_ffi libkreuzcrawl_ffi)
endif()
...
if(NOT _FFI_INCLUDE_DIR)
  find_path(_FFI_INCLUDE_DIR NAMES kreuzcrawl.h)
endif()
...
if(kreuzcrawl_ffi_FOUND)
  ...
  add_library(kreuzcrawl-ffi::kreuzcrawl-ffi ${_FFI_LIB_TYPE} IMPORTED)
