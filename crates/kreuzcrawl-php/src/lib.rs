...
// alef:hash:b9f4fb56e3076ec69e31100a69bc9a53db59605531bc661fdb34f3531ec313b1
...
impl ScrapeResult {
    ...
    pub fn new(
        ...
        Self {
            ...
            screenshot: screenshot.map(|b| b.0),
...
impl From<ScrapeResult> for kreuzcrawl::ScrapeResult {
    fn from(val: ScrapeResult) -> Self {
        Self {
            ...
            screenshot: val.screenshot.map(|v| v.into()),
