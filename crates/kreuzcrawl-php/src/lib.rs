...
// alef:hash:367a7a5048bd29270be62f501d6dab6215529fbae0c6ffeb5e1c124b97eeaff4
...
impl KreuzcrawlApi {
     ...
     */
    pub fn batch_scrape(engine: &CrawlEngineHandle, urls: Vec<String>) -> PhpResult<String> {
        Err(ext_php_rs::exception::PhpException::default(
            "Not implemented: batch_scrape".to_string(),
        ))
    }
     ...
     */
    pub fn batch_crawl(engine: &CrawlEngineHandle, urls: Vec<String>) -> PhpResult<String> {
        Err(ext_php_rs::exception::PhpException::default(
            "Not implemented: batch_crawl".to_string(),
        ))
    }
}
