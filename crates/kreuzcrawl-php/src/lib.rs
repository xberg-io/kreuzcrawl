...
// alef:hash:78d87c2d8d062afb0bd184a0ddc8bc80a0851befca648e80459fab4c14677c4f
...
impl KreuzcrawlApi {
     ...
     */
    pub fn batch_scrape_async(engine: &CrawlEngineHandle, urls: Vec<String>) -> PhpResult<Vec<BatchScrapeResult>> {
        WORKER_RUNTIME.block_on(async {
     ...
     */
    pub fn batch_crawl_async(engine: &CrawlEngineHandle, urls: Vec<String>) -> PhpResult<Vec<BatchCrawlResult>> {
        WORKER_RUNTIME.block_on(async {
