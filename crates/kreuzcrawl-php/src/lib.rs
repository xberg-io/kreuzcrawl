...
// alef:hash:a88fae5199be401f6a26a7881eccf2a101399c8dab3ff81fa3f30afaf3d82b23
...
impl CrawlResult {
    ...
    #[php(constructor)]
    pub fn new(finalUrl: String, redirectCount: i64, wasSkipped: bool, error: Option<String>) -> Self {
        Self {
...
impl From<CrawlEvent> for kreuzcrawl::CrawlEvent {
    fn from(val: CrawlEvent) -> Self {
        match val.type_tag.as_str() {
            ...
            _ => kreuzcrawl::CrawlEvent::Page {
                result: Box::new(Default::default()),
            },
        }
    }
}
