...
pub struct BrowserConfig {
    ...
    #[php(prop, name = "stealth")]
    #[serde(default = "crate::serde_defaults::browser_config_stealth")]
    pub stealth: bool,
...
mod serde_defaults {
    ...
    pub fn browser_config_stealth() -> bool {
        false
    }
...
pub extern "C" fn get_module() -> *mut ::ext_php_rs::zend::ModuleEntry {
    ...
    __EXT_PHP_RS_MODULE_ENTRY.get_or_init(|| {
        let builder = ::ext_php_rs::builders::ModuleBuilder::new("kreuzcrawl", "0.3.0-rc.52")
