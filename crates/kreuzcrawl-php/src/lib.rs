...
// alef:hash:9951a713c54ebb97a26b5ab341ee2c7851fa0bd600c421ec7be9d90c6c160437
...
impl BrowserConfig {
    ...
    pub fn getProxy(&self) -> Option<ProxyConfig> {
        self.proxy.clone()
    }
...
impl CrawlConfig {
    ...
    pub fn getCustomHeaders(&self) -> HashMap<String, String> {
        self.custom_headers.clone()
    }

    pub fn getAuth(&self) -> Option<AuthConfig> {
        self.auth.clone()
    }

    pub fn getContent(&self) -> ContentConfig {
        self.content.clone()
    }

    pub fn getBrowser(&self) -> BrowserConfig {
        self.browser.clone()
    }
...
impl BrowserExtras {
    ...
    pub fn getEvalResult(&self) -> Option<String> {
        self.eval_result.as_ref().and_then(|v| serde_json::to_string(v).ok())
    }

    pub fn getNetworkEvents(&self) -> Vec<ResponseMeta> {
        self.network_events.clone()
    }

    pub fn getCookies(&self) -> Vec<CookieInfo> {
        self.cookies.clone()
    }
}
...
impl DownloadedDocument {
    ...
    pub fn getHeaders(&self) -> HashMap<String, String> {
        self.headers.clone()
    }
}
...
impl ScrapeResult {
    ...
    pub fn getMetadata(&self) -> PageMetadata {
        self.metadata.clone()
    }

    pub fn getLinks(&self) -> Vec<LinkInfo> {
        self.links.clone()
    }

    pub fn getImages(&self) -> Vec<ImageInfo> {
        self.images.clone()
    }

    pub fn getFeeds(&self) -> Vec<FeedInfo> {
        self.feeds.clone()
    }

    pub fn getJsonLd(&self) -> Vec<JsonLdEntry> {
        self.json_ld.clone()
    }

    pub fn getResponseMeta(&self) -> Option<ResponseMeta> {
        self.response_meta.clone()
    }

    pub fn getAssets(&self) -> Vec<DownloadedAsset> {
        self.assets.clone()
    }

    pub fn getMarkdown(&self) -> Option<MarkdownResult> {
        self.markdown.clone()
    }

    pub fn getExtractedData(&self) -> Option<String> {
        self.extracted_data.as_ref().and_then(|v| serde_json::to_string(v).ok())
    }

    pub fn getExtractionMeta(&self) -> Option<ExtractionMeta> {
        self.extraction_meta.clone()
    }

    pub fn getDownloadedDocument(&self) -> Option<DownloadedDocument> {
        self.downloaded_document.clone()
    }

    pub fn getBrowser(&self) -> Option<BrowserExtras> {
        self.browser.clone()
    }
}
...
impl CrawlResult {
    ...
    pub fn getPages(&self) -> Vec<CrawlPageResult> {
        self.pages.clone()
    }
...
impl MapResult {
    ...
    pub fn getUrls(&self) -> Vec<SitemapUrl> {
        self.urls.clone()
    }
}
...
impl MarkdownResult {
    ...
    pub fn getDocumentStructure(&self) -> Option<String> {
        self.document_structure
            .as_ref()
            .and_then(|v| serde_json::to_string(v).ok())
    }

    pub fn getTables(&self) -> Option<String> {
        serde_json::to_string(&self.tables).ok()
    }

    pub fn getCitations(&self) -> Option<CitationResult> {
...
impl PageMetadata {
    ...
    pub fn getArticle(&self) -> Option<ArticleMetadata> {
        self.article.clone()
    }

    pub fn getHreflangs(&self) -> Option<Vec<HreflangEntry>> {
        self.hreflangs.clone()
    }

    pub fn getFavicons(&self) -> Option<Vec<FaviconInfo>> {
        self.favicons.clone()
    }

    pub fn getHeadings(&self) -> Option<Vec<HeadingInfo>> {
        self.headings.clone()
    }
}
...
impl CitationResult {
    ...
    pub fn getReferences(&self) -> Vec<CitationReference> {
...
impl BatchScrapeResult {
    ...
    pub fn getResult(&self) -> Option<ScrapeResult> {
        self.result.clone()
    }
}
...
impl BatchCrawlResult {
    ...
    pub fn getResult(&self) -> Option<CrawlResult> {
        self.result.clone()
    }
}
