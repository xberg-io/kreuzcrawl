...
// BrowserBackend enum values
pub const BROWSERBACKEND_CHROMIUMOXIDE: &str = "Chromiumoxide";
pub const BROWSERBACKEND_NATIVE: &str = "Native";
...
pub const SCROLLDIRECTION_UP: &str = "Up";
pub const SCROLLDIRECTION_DOWN: &str = "Down";
