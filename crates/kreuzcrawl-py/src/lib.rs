...
// alef:hash:d1d9b77777eff5512d3f25540bc3e1de07ab2d088395aed8cac26a41f9493656
...
impl BrowserConfig {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (mode=None, backend=None, timeout=None, wait=None, stealth=None, block_url_patterns=None, capture_network_events=None, endpoint=None, wait_selector=None, extra_wait=None, proxy=None, eval_script=None, robots_user_agent=None))]
    #[new]
    pub fn new(
        ...
        Self {
            ...
            proxy,
            block_url_patterns: block_url_patterns.unwrap_or_default(),
            eval_script,
            robots_user_agent,
            capture_network_events: capture_network_events.unwrap_or(false),
        }
    }
...
impl BrowserExtras {
    #[must_use]
    #[pyo3(signature = (network_events=None, cookies=None, eval_result=None))]
    #[new]
    pub fn new(
        network_events: Option<Vec<ResponseMeta>>,
        cookies: Option<Vec<CookieInfo>>,
        eval_result: Option<String>,
    ) -> Self {
        Self {
            eval_result,
            network_events: network_events.unwrap_or_default(),
...
impl DownloadedDocument {
    #[must_use]
    #[pyo3(signature = (url=None, mime_type=None, size=None, content_hash=None, headers=None, filename=None))]
    #[new]
    pub fn new(
        url: Option<String>,
...
impl InteractionResult {
    #[must_use]
    #[pyo3(signature = (action_results=None, final_html=None, final_url=None))]
    #[new]
    pub fn new(
...
impl CrawlPageResult {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (url=None, normalized_url=None, status_code=None, content_type=None, html=None, body_size=None, metadata=None, links=None, images=None, feeds=None, json_ld=None, depth=None, stayed_on_domain=None, was_skipped=None, is_pdf=None, browser_used=None, detected_charset=None, markdown=None, extracted_data=None, extraction_meta=None, downloaded_document=None))]
    #[new]
    pub fn new(
        url: Option<String>,
...
impl CrawlResult {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (pages=None, final_url=None, redirect_count=None, was_skipped=None, cookies=None, stayed_on_domain=None, browser_used=None, error=None))]
    #[new]
    pub fn new(
...
impl MarkdownResult {
    ...
    pub fn new(
        ...
        Self {
            ...
            citations: citations.unwrap_or(false),
            fit_content,
        }
    }
...
impl BatchScrapeResults {
    #[must_use]
    #[pyo3(signature = (results=None, total_count=None, completed_count=None, failed_count=None))]
    #[new]
    pub fn new(
        results: Option<Vec<BatchScrapeResult>>,
        ...
        Self {
            ...
            completed_count: completed_count.unwrap_or_default(),
            failed_count: failed_count.unwrap_or_default(),
        }
    }
...
impl BatchCrawlResults {
    ...
    #[new]
    pub fn new(
        results: Option<Vec<BatchCrawlResult>>,
        total_count: Option<usize>,
        completed_count: Option<usize>,
        failed_count: Option<usize>,
    ) -> Self {
