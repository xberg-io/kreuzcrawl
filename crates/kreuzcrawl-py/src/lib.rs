...
// Error types
pyo3::create_exception!(_kreuzcrawl, DeniedByPolicyError, pyo3::exceptions::PyException);
pyo3::create_exception!(_kreuzcrawl, NotOnAllowlistError, pyo3::exceptions::PyException);
pyo3::create_exception!(_kreuzcrawl, DnsResolutionFailedError, pyo3::exceptions::PyException);
pyo3::create_exception!(_kreuzcrawl, InvalidUrlError, pyo3::exceptions::PyException);
pyo3::create_exception!(_kreuzcrawl, DisallowedSchemeError, pyo3::exceptions::PyException);
pyo3::create_exception!(_kreuzcrawl, TooManyRedirectsError, pyo3::exceptions::PyException);
pyo3::create_exception!(_kreuzcrawl, SsrfError, pyo3::exceptions::PyException);

/// Convert a `kreuzcrawl::SsrfError` error to a Python exception.
fn ssrf_error_to_py_err(e: kreuzcrawl::SsrfError) -> pyo3::PyErr {
    let msg = e.to_string();
    #[allow(unreachable_patterns)]
    match &e {
        kreuzcrawl::SsrfError::DeniedByPolicy { .. } => DeniedByPolicyError::new_err(msg),
        kreuzcrawl::SsrfError::NotOnAllowlist => NotOnAllowlistError::new_err(msg),
        kreuzcrawl::SsrfError::DnsResolutionFailed(..) => DnsResolutionFailedError::new_err(msg),
        kreuzcrawl::SsrfError::InvalidUrl(..) => InvalidUrlError::new_err(msg),
        kreuzcrawl::SsrfError::DisallowedScheme(..) => DisallowedSchemeError::new_err(msg),
        kreuzcrawl::SsrfError::TooManyRedirects => TooManyRedirectsError::new_err(msg),
