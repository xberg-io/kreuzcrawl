...
impl BrowserConfig {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (mode=Self::default().mode, backend=Self::default().backend, timeout=None, wait=Self::default().wait, stealth=Self::default().stealth, block_url_patterns=Self::default().block_url_patterns, capture_network_events=Self::default().capture_network_events, session_affinity=Self::default().session_affinity, endpoint=None, wait_selector=None, extra_wait=None, proxy=None, eval_script=None, robots_user_agent=None))]
    #[new]
    pub fn new(
        mode: BrowserMode,
...
impl CrawlConfig {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (respect_robots_txt=Self::default().respect_robots_txt, soft_http_errors=Self::default().soft_http_errors, stay_on_domain=Self::default().stay_on_domain, allow_subdomains=Self::default().allow_subdomains, include_paths=Self::default().include_paths, exclude_paths=Self::default().exclude_paths, custom_headers=Self::default().custom_headers, request_timeout=None, max_redirects=Self::default().max_redirects, retry_count=Self::default().retry_count, retry_codes=Self::default().retry_codes, cookies_enabled=Self::default().cookies_enabled, remove_tags=Self::default().remove_tags, content=None, download_assets=Self::default().download_assets, asset_types=Self::default().asset_types, browser=None, user_agents=Self::default().user_agents, capture_screenshot=Self::default().capture_screenshot, download_documents=Self::default().download_documents, document_mime_types=Self::default().document_mime_types, save_browser_profile=Self::default().save_browser_profile, max_depth=None, max_pages=None, max_concurrent=None, user_agent=None, rate_limit_ms=None, auth=None, max_body_size=None, map_limit=None, map_search=None, max_asset_size=None, proxy=None, document_max_size=None, warc_output=None, browser_profile=None))]
    #[new]
    pub fn new(
