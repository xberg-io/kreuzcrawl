...
dependencies {
    ...
    implementation("dev.kreuzberg.kreuzcrawl.android:kreuzcrawl-android:0.3.0-rc.82")
...
tasks.register("verifyAarPublished") {
    ...
    doLast {
        val aarCoord = "dev.kreuzberg.kreuzcrawl.android:kreuzcrawl-android:0.3.0-rc.82"
