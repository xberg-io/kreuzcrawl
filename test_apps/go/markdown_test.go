...
// alef:hash:0d95b9414b357474c9e22c7bec67e27b2b101b8c90549279091684318005f8e0
...
func Test_MarkdownCrawlAllPages(t *testing.T) {
	...
	if url == "" { url = os.Getenv("MOCK_SERVER_URL") + "/fixtures/markdown_crawl_all_pages" }
...
func Test_MarkdownFitContent(t *testing.T) {
	...
	if url == "" { url = os.Getenv("MOCK_SERVER_URL") + "/fixtures/markdown_fit_content" }
	result, err := pkg.Scrape(engine, url)
	if err != nil {
		t.Fatalf("call failed: %v", err)
	}
