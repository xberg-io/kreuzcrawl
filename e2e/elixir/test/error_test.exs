...
# alef:hash:5214cf4c3a9ab78a8dad36c8b1c630d107bef538bd2aaf5ca37317d6aa141729
...
defmodule E2e.ErrorTest do
  ...
  describe "error_browser_launch_failure" do
    test "error_browser_launch_failure" do
      engine_config = "{\"browser\":{\"mode\":\"always\"},\"browser_launch_timeout_ms\":1}"
  ...
  describe "error_browser_page_timeout" do
    test "error_browser_page_timeout" do
      engine_config = "{\"browser\":{\"mode\":\"always\"},\"page_load_timeout_ms\":1}"
      {:ok, engine} = Kreuzcrawl.create_engine(engine_config)
