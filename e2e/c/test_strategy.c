...
// alef:hash:83a9e39a216e856a5c0fef7c9385fcf0683b070b1b932bafcb26c3c384ad1f65
...
void test_strategy_adaptive_saturation(void) {
    ...
    assert(pages >= 1 && "expected greater than or equal");
...
void test_strategy_adaptive_window(void) {
    ...
    assert(result != NULL && "expected call to succeed");
    char* pages = kcrawl_crawl_result_pages(result);
    assert(pages >= 3 && "expected greater than or equal");
    kcrawl_free_string(pages);
    kcrawl_crawl_result_free(result);
    kcrawl_crawl_engine_handle_free(engine);
}
