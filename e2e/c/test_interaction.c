...
// alef:hash:ef8549916eae2f05dea89b22a060686ff36546583a3e0ce03220e2024002526a
...
void test_interact_action_sequence(void) {
    ...
    KCRAWLInteractionResult* result = kcrawl_interact(engine, url);
    assert(result != NULL && "expected call to succeed");
    KCRAWLInteraction* interaction_handle = kcrawl_interaction_result_interaction(result);
    assert(interaction_handle != NULL);
    char* action_results_json = kcrawl_interaction_action_results(interaction_handle);
    ...
    kcrawl_free_free(action_results_2_json);
    kcrawl_free_free(action_results_1_json);
    kcrawl_free_free(action_results_0_json);
    kcrawl_free_string(action_results_json);
    kcrawl_interaction_free(interaction_handle);
...
void test_interact_invalid_selector(void) {
    ...
    assert(str_trim_eq(interaction_action_results_0_action_type, "click") == 0 && "equals assertion failed");
    assert(interaction_action_results_0_error != NULL && strstr(interaction_action_results_0_error, "not found") != NULL && "expected to contain substring");
    free(interaction_action_results_0_success);
    free(interaction_action_results_0_action_type);
...
void test_interact_screenshot(void) {
    ...
    assert(interaction_action_results_0_data);
    free(interaction_action_results_0_success);
    free(interaction_action_results_0_action_type);
    free(interaction_action_results_0_data);
    kcrawl_free_free(action_results_0_json);
