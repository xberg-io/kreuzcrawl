...
// alef:hash:903c4ad118e504d19af6e26bbe1ca56d5b81202ab4f584bfd5902f41c43149f9
...
void test_cookies_per_domain(void) {
    ...
    KCRAWLCookies* cookies_handle = kcrawl_scrape_result_cookies(result);
    assert(cookies_handle != NULL);
    char* cookies_length = kcrawl_cookies_length(cookies_handle);
    char* cookies = kcrawl_scrape_result_cookies(result);
    assert(strcmp(cookies_length, 1) == 0 && "equals assertion failed");
