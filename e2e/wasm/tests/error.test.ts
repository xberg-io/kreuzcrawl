...
// alef:hash:13a043f017ed53f264768a61e6ea01240d0eb158752e15bac8b460b58c6ed299
...
describe("error", () => {
  ...
  it("error_empty_response: Handles 200 with completely empty body gracefully", async () => {
    ...
    await scrape(engine, url); // skipped: field 'html_not_empty' not available on result type
