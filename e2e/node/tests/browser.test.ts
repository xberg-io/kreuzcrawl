...
// alef:hash:6328a401db2a9fd4413e3ca7370fa42e55e049a345077e9317a874b70c8a3068
...
describe("browser", () => {
  ...
  it("browser_profile_basic: Browser profile configuration persists and reuses browser state across crawl sessions", async () => {
    ...
    const result = await scrape(engine, url); // skipped: field 'browser.browser_used' not available on result type
    expect(result.statusCode).toBe(200);
  });
