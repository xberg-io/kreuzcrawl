...
// alef:hash:9b691a161f16d703fd1ccded1afe2e3a5e674d230e9d15b077d27750927e0ed1
...
void main() {
  ...
  test('Crawl with browser mode \'always\' follows links using browser rendering', () async {
    ...
    final engine = await KreuzcrawlBridge.createEngine(engineConfig);
    final url = _mockServerFor("browser_crawl_mode_always", "MOCK_SERVER_BROWSER_CRAWL_MODE_ALWAYS");
  ...
  test('Crawl with browser mode \'auto\' falls back to browser when encountering WAF 403', () async {
    ...
    final engine = await KreuzcrawlBridge.createEngine(engineConfig);
    final url = _mockServerFor("browser_crawl_waf_fallback", "MOCK_SERVER_BROWSER_CRAWL_WAF_FALLBACK");
    final result = await KreuzcrawlBridge.crawl(engine, url);
