...
// alef:hash:63c42a433a3284f2ed2fd79c23c10ecfa9e5aa0c4505e676e81ac28719298be5
...
void main() {
  ...
  test('Follows 301 permanent redirect and returns final page content', () async {
    ...
    final url = _mockServerFor("redirect_301_permanent", "MOCK_SERVER_REDIRECT_301_PERMANENT");
  ...
  test('Follows 302 Found redirect correctly', () async {
    final engineConfig = await createCrawlConfigFromJson(json: r'{"respect_robots_txt":false}');
    final engine = await KreuzcrawlBridge.createEngine(engineConfig);
    final url = _mockServerFor("redirect_302_found", "MOCK_SERVER_REDIRECT_302_FOUND");
    final result = await KreuzcrawlBridge.crawl(engine, url);
  ...
  test('Follows 303 See Other redirect (method changes to GET)', () async {
    final engineConfig = await createCrawlConfigFromJson(json: r'{"respect_robots_txt":false}');
    final engine = await KreuzcrawlBridge.createEngine(engineConfig);
    final url = _mockServerFor("redirect_303_see_other", "MOCK_SERVER_REDIRECT_303_SEE_OTHER");
    final result = await KreuzcrawlBridge.crawl(engine, url);
  ...
  test('Follows 307 Temporary Redirect (preserves method)', () async {
    final engineConfig = await createCrawlConfigFromJson(json: r'{"respect_robots_txt":false}');
    final engine = await KreuzcrawlBridge.createEngine(engineConfig);
    final url = _mockServerFor("redirect_307_temporary", "MOCK_SERVER_REDIRECT_307_TEMPORARY");
    final result = await KreuzcrawlBridge.crawl(engine, url);
  ...
  test('Follows 308 Permanent Redirect (preserves method)', () async {
    final engineConfig = await createCrawlConfigFromJson(json: r'{"respect_robots_txt":false}');
    final engine = await KreuzcrawlBridge.createEngine(engineConfig);
    final url = _mockServerFor("redirect_308_permanent", "MOCK_SERVER_REDIRECT_308_PERMANENT");
    final result = await KreuzcrawlBridge.crawl(engine, url);
  ...
  test('Reports cross-domain redirect target without following to external domain', () async {
    final engineConfig = await createCrawlConfigFromJson(json: r'{"respect_robots_txt":false}');
    final engine = await KreuzcrawlBridge.createEngine(engineConfig);
    final url = _mockServerFor("redirect_cross_domain", "MOCK_SERVER_REDIRECT_CROSS_DOMAIN");
    final result = await KreuzcrawlBridge.crawl(engine, url);
  ...
  test('Aborts when redirect count exceeds max_redirects limit', () async {
    ...
    final engine = await KreuzcrawlBridge.createEngine(engineConfig);
    final url = _mockServerFor("redirect_max_exceeded", "MOCK_SERVER_REDIRECT_MAX_EXCEEDED");
    final result = await KreuzcrawlBridge.crawl(engine, url);
    // skipped: field 'is_error' not available on dart result type
  });
  ...
  test('Handles HTTP Refresh header redirect', () async {
    final engineConfig = await createCrawlConfigFromJson(json: r'{"respect_robots_txt":false}');
    final engine = await KreuzcrawlBridge.createEngine(engineConfig);
    final url = _mockServerFor("redirect_refresh_header", "MOCK_SERVER_REDIRECT_REFRESH_HEADER");
    final result = await KreuzcrawlBridge.crawl(engine, url);
  ...
  test('Redirect target returns 404 Not Found', () async {
    final engineConfig = await createCrawlConfigFromJson(json: r'{"respect_robots_txt":false}');
    final engine = await KreuzcrawlBridge.createEngine(engineConfig);
    final url = _mockServerFor("redirect_to_404", "MOCK_SERVER_REDIRECT_TO_404");
    final result = await KreuzcrawlBridge.crawl(engine, url);
