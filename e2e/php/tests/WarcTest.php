...
// alef:hash:9a684ebb8c90801ece7b030ca1a100e4a722ef5ff81dbdc99188e8539c89d910
...
final class WarcTest extends TestCase
{
    ...
    public function test_warc_multi_page_crawl(): void
    {
        ...
        $result = Kreuzcrawl::scrape($engine, $url);
        // skipped: field 'pages.length' not available on result type            $this->assertEquals(true, $result->stayedOnDomain);
