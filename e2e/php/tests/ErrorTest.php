...
// alef:hash:6cb831ddb753a2a99ce93330fb3a22c53b2c4d87cd2bf1bc316b8a78bc959f7c
...
final class ErrorTest extends TestCase
{
    ...
    {
        $this->expectException(\Exception::class);
        $engine_config = CrawlConfig::from_json(json_encode(["browser" => ["mode" => "always"], "browserLaunchTimeoutMs" => 1]));
    ...
    {
        $this->expectException(\Exception::class);
        $engine_config = CrawlConfig::from_json(json_encode(["browser" => ["mode" => "always"], "pageLoadTimeoutMs" => 1]));
        $engine = Kreuzcrawl::createEngine($engine_config);
