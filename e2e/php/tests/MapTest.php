...
// alef:hash:7688d45c40a73cb292b6c133592ab0b732f30d57c270ab95a8ff60bb59be34a0
...
final class MapTest extends TestCase
{
    ...
    public function test_map_include_subdomains(): void
    {
        ...
        $this->assertStringContainsString("blog.example.com", $result->getUrls());
    ...
    public function test_map_search_filter(): void
    {
        ...
        $result = Kreuzcrawl::mapUrls($engine, $url);
        $this->assertGreaterThanOrEqual(2, count($result->getUrls()));
        $this->assertStringContainsString("blog", $result->getUrls());
