...
// alef:hash:0cd2e9fecb3809366487f451a598d576a9ce62a121293e92943e929b8d513e71
...
final class StrategyTest extends TestCase
{
    ...
    {
        $engine_config = CrawlConfig::from_json(json_encode(["max_concurrent" => 1, "max_depth" => 2, "respect_robots_txt" => false]));
