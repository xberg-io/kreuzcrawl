...
// alef:hash:c9896488e388d178d6eb62685794fd57c555dbe6949a92e82acaac4320d456ad
...
final class RobotsTest extends TestCase
{
    ...
    {        $engine_config = CrawlConfig::from_json(json_encode(["respect_robots_txt" => true]));
    ...
    {        $engine_config = CrawlConfig::from_json(json_encode(["respect_robots_txt" => true, "user_agent" => "kreuzcrawl"]));
        $engine = Kreuzcrawl::createEngine($engine_config);
    ...
    {        $engine_config = CrawlConfig::from_json(json_encode(["respect_robots_txt" => true, "user_agent" => "kreuzcrawl"]));
        ...
        $result = Kreuzcrawl::scrape($engine, $url);
            $this->assertEquals(2, $result->crawlDelay);
    ...
    {        $engine_config = CrawlConfig::from_json(json_encode(["respect_robots_txt" => true, "user_agent" => "SpecificBot"]));
        $engine = Kreuzcrawl::createEngine($engine_config);
    ...
    {        $engine_config = CrawlConfig::from_json(json_encode(["respect_robots_txt" => true, "user_agent" => "kreuzcrawl"]));
        ...
        $result = Kreuzcrawl::scrape($engine, $url);
            $this->assertEquals(5, $result->crawlDelay);
            $this->assertEquals(true, $result->isAllowed);
    ...
    {        $engine_config = CrawlConfig::from_json(json_encode(["respect_robots_txt" => true, "user_agent" => "KreuzcrawlBot"]));
        $engine = Kreuzcrawl::createEngine($engine_config);
    ...
    {        $engine_config = CrawlConfig::from_json(json_encode(["respect_robots_txt" => true]));
        ...
        $result = Kreuzcrawl::scrape($engine, $url);
            $this->assertEquals("noindex, nofollow", trim($result->xRobotsTag));
            $this->assertEquals(true, $result->noindexDetected);
            $this->assertEquals(true, $result->nofollowDetected);
