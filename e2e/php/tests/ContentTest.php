...
// alef:hash:2867d6c1630df7ad54f624c4c86cc2d6e3c5493fe2129ae14ec1bc4e523231cf
...
final class ContentTest extends TestCase
{
    ...
    {        $engine_config = CrawlConfig::from_json(json_encode(["respect_robots_txt" => false]));
        ...
        $result = Kreuzcrawl::scrape($engine, $url);
            $this->assertEquals("iso-8859-1", trim($result->detectedCharset));
    ...
    {        $engine_config = CrawlConfig::from_json(json_encode(["max_body_size" => 1024, "respect_robots_txt" => false]));
        $engine = Kreuzcrawl::createEngine($engine_config);
    ...
    {        $engine_config = CrawlConfig::from_json(json_encode(["content" => ["preprocessing_preset" => "aggressive"], "respect_robots_txt" => false]));
        $engine = Kreuzcrawl::createEngine($engine_config);
    ...
    {        $engine_config = CrawlConfig::from_json(json_encode(["remove_tags" => ["nav", "aside", "footer"], "respect_robots_txt" => false]));
        $engine = Kreuzcrawl::createEngine($engine_config);
    ...
    {        $engine_config = CrawlConfig::from_json(json_encode(["respect_robots_txt" => false]));
        ...
        $result = Kreuzcrawl::scrape($engine, $url);
            $this->assertEquals("utf-8", trim($result->detectedCharset));
            $this->assertNotEmpty($result->html);
