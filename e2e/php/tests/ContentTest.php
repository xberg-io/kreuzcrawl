...
// alef:hash:a151b3b7f607320e5007c8f0d09b5254cd6a584384c798a0f190fc6563131ef7
...
final class ContentTest extends TestCase
{
    ...
    public function test_content_charset_iso8859(): void
    {
        ...
        $result = Kreuzcrawl::scrape($engine, $url);
        $this->assertEquals("iso-8859-1", trim($result->detected_charset));
    }
    ...
    public function test_content_utf8_bom(): void
    {
        ...
        $result = Kreuzcrawl::scrape($engine, $url);
        $this->assertEquals("utf-8", trim($result->detected_charset));
        $this->assertNotEmpty($result->html);
    }
}
