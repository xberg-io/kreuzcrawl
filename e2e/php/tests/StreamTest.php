...
// alef:hash:ae3ed60afe7221e3db40ddd8373e943565a48e199fa26f3cb720220813238fb8
...
final class StreamTest extends TestCase
{
    ...
    {
        $engine_config = CrawlConfig::from_json(json_encode(["max_concurrent" => 2]));
        ...
        $result = Kreuzcrawl::batchCrawlStream($engine, $urls);
    ...
    {
        $engine_config = CrawlConfig::from_json(json_encode(["max_concurrent" => 1]));
        $engine = Kreuzcrawl::createEngine($engine_config);
    ...
    {
        $engine_config = CrawlConfig::from_json(json_encode(["max_concurrent" => 1, "max_depth" => 1, "respect_robots_txt" => false]));
        $engine = Kreuzcrawl::createEngine($engine_config);
