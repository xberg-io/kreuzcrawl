...
// alef:hash:bafb117e323f70c59888edaba1ee63a9a543ff03998a55601a1b1869166d15e9
...
final class BrowserTest extends TestCase
{
    ...
    public function test_browser_config_auto_no_feature(): void
    {
        ...
        $this->assertEquals(true, $result->getBrowser()->jsRenderHint);
        $this->assertEquals(false, $result->getBrowser()->browserUsed);
    ...
    public function test_browser_crawl_mode_always(): void
    {
        ...
        $result = Kreuzcrawl::scrape($engine, $url);
        // skipped: field 'pages.length' not available on result type            $this->assertEquals(true, $result->getBrowser()->browserUsed);
    ...
    public function test_browser_detect_minimal_page(): void
    {
        ...
        $result = Kreuzcrawl::scrape($engine, $url);
        $this->assertEquals(200, $result->statusCode);
        $this->assertEquals(false, $result->getBrowser()->jsRenderHint);
        $this->assertEquals(false, $result->getBrowser()->browserUsed);
    ...
    public function test_browser_extra_wait(): void
    {
        ...
        $result = Kreuzcrawl::scrape($engine, $url);
        $this->assertEquals(true, $result->getBrowser()->browserUsed);
