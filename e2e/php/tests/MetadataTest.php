...
// alef:hash:4bf419074494958a3b3e90eb1512a217a56b83653815c6c353f898375879b9b4
...
final class MetadataTest extends TestCase
{
    ...
    public function test_metadata_word_count(): void
    {
        ...
        $this->assertEquals(200, $result->statusCode);
        $this->assertGreaterThan(99, $result->getMetadata()->wordCount);
        $this->assertLessThan(301, $result->getMetadata()->wordCount);
