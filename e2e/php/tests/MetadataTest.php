...
// alef:hash:a0d124474e4249c2be7f2e3bffcb49d188760a2ce3c1689e9d16c9763ef9f2d7
...
final class MetadataTest extends TestCase
{
    ...
    public function test_metadata_keywords_author(): void
    {
        ...
        $this->assertEquals("#ff6600", trim($result->metadata->theme_color));
        $this->assertEquals("index, follow", trim($result->metadata->robots));
        $this->assertEquals("en", trim($result->metadata->html_lang));
        $this->assertEquals("ltr", trim($result->metadata->html_dir));
    }
    ...
    public function test_metadata_og_video_audio(): void
    {
        ...
        $result = Kreuzcrawl::scrape($engine, $url);
        $this->assertEquals(200, $result->status_code);
        $this->assertEquals("https://example.com/video.mp4", trim($result->metadata->og_video));
        $this->assertEquals("https://example.com/audio.mp3", trim($result->metadata->og_audio));
