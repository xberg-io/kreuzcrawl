...
// alef:hash:e846a2b6c31a256dc3277d45bc0613a10e25b7ce9b2a85d0ab44802d0136a725
...
final class ScrapeTest extends TestCase
{
    ...
    public function test_scrape_basic_html_page(): void
    {
        ...
        $result = Kreuzcrawl::scrape($engine, $url);
        $this->assertEquals(200, $result->status_code);
        $this->assertEquals("text/html", trim($result->content_type));
    ...
    public function test_scrape_dublin_core(): void
    {
        ...
        $this->assertEquals("Effects of Climate Change on Marine Biodiversity", trim($result->metadata->dc_title));
        $this->assertEquals("Dr. Jane Smith", trim($result->metadata->dc_creator));
    }
    ...
    public function test_scrape_image_sources(): void
    {
        ...
        $this->assertEquals("https://example.com/images/og-hero.jpg", trim($result->metadata->og_image));
    }
    ...
    public function test_scrape_json_ld(): void
    {
        ...
        $this->assertEquals("Recipe", trim($result->json_ld[0]->schema_type));
        $this->assertEquals("Best Chocolate Cake", trim($result->json_ld[0]->name));
    }
    ...
    public function test_scrape_og_metadata(): void
    {
        ...
        $this->assertEquals("Article Title", trim($result->metadata->og_title));
        $this->assertEquals("article", trim($result->metadata->og_type));
        $this->assertEquals("https://example.com/images/article-hero.jpg", trim($result->metadata->og_image));
    ...
    public function test_scrape_twitter_card(): void
    {
        ...
        $this->assertEquals("summary_large_image", trim($result->metadata->twitter_card));
        $this->assertEquals("New Product Launch", trim($result->metadata->twitter_title));
    }
}
