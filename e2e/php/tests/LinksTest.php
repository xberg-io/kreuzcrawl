...
// alef:hash:cdccc3ce74f53936358f93ee1bfdfd52e282b465c9fc564de470741ca29844e0
...
final class LinksTest extends TestCase
{
    ...
    public function test_links_anchor_fragment(): void
    {
        ...
        $this->assertStringContainsString("anchor", $result->links[0]->linkType);
    ...
    public function test_links_document_types(): void
    {
        ...
        $result = Kreuzcrawl::scrape($engine, $url);
        $this->assertStringContainsString("document", $result->links[0]->linkType);
