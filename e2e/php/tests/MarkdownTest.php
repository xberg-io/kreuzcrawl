...
// alef:hash:28bb086b1a6614de8638d4eee8fc5ef02708ebfc4bfbd0c6ec86fcfe97f5c51d
...
final class MarkdownTest extends TestCase
{
    ...
    public function test_citations_duplicate_urls(): void
    {
        ...
        $this->assertEquals(200, $result->statusCode);
        $this->assertNotEmpty($result->getMarkdown()->content);
        $this->assertTrue($result->getMarkdown()->getCitations());
    ...
    public function test_markdown_basic_conversion(): void
    {
        ...
        $result = Kreuzcrawl::scrape($engine, $url);
        $this->assertEquals(200, $result->statusCode);
        $this->assertEquals("Test", trim($result->getMetadata()->title));
