...
// alef:hash:77e7958df39963503387f68b204e6cb805e18c3e22f492d901bd68516b84e9b7
...
namespace Kreuzcrawl
{
    ...
    Assert.True(result.StatusCode == 200);
        ...
        public async Task Test_BrowserDetectNextRendered()
        {
            ...
            var result = await KreuzcrawlLib.Scrape(engine, url);
    Assert.True(result.StatusCode == 200);
            // skipped: field 'html_not_empty' not available on result type        // skipped: field 'browser.js_render_hint' not available on result type        // skipped: field 'browser.browser_used' not available on result type
        }
    ...
    Assert.True(result.StatusCode == 200);
        ...
        public async Task Test_BrowserProfileBasic()
        {
            ...
            var result = await KreuzcrawlLib.Scrape(engine, url);
            // skipped: field 'browser.browser_used' not available on result typeAssert.True(result.StatusCode == 200);
