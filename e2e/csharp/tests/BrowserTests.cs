...
// alef:hash:fd6e6c7468c1565ccb3edcc768d1f652c57adaa22e61c044a0946140ba1661c7
...
namespace Kreuzcrawl
{
    ...
    Assert.True(result.Browser.JsRenderHint);
    Assert.False(result.Browser.BrowserUsed);
    ...
    Assert.False(result.Browser.BrowserUsed);
        ...
        public async Task Test_BrowserCrawlModeAlways()
        {
            ...
            var result = await KreuzcrawlLib.Scrape(engine, url);
            // skipped: field 'pages.length' not available on result typeAssert.True(result.Browser.BrowserUsed);
        ...
        public async Task Test_BrowserDetectMinimalPage()
        {
            ...
            var result = await KreuzcrawlLib.Scrape(engine, url);
    Assert.True(result.StatusCode == 200);
    Assert.False(result.Browser.JsRenderHint);
    Assert.False(result.Browser.BrowserUsed);
    ...
    Assert.False(result.Browser.BrowserUsed);
        ...
        public async Task Test_BrowserExtraWait()
        {
            ...
            var result = await KreuzcrawlLib.Scrape(engine, url);
    Assert.True(result.Browser.BrowserUsed);
