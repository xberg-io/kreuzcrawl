...
// alef:hash:eb47c58759bcd86ddc2eb3fdd146fd57ca3b49c5279498653ff31a337880f152
...
namespace Kreuzcrawl
{
    ...
    public class ErrorTests
    {
        ...
        public async Task Test_ErrorBrowserLaunchFailure()
        {
            ...
            await Assert.ThrowsAnyAsync<KreuzcrawlException>(async () =>
            {
                var engineConfig = JsonSerializer.Deserialize<CrawlConfig>("{\"browser\":{\"mode\":\"always\"},\"browser_launch_timeout_ms\":1}", ConfigOptions)!;
        ...
        public async Task Test_ErrorBrowserPageTimeout()
        {
            ...
            await Assert.ThrowsAnyAsync<KreuzcrawlException>(async () =>
            {
                var engineConfig = JsonSerializer.Deserialize<CrawlConfig>("{\"browser\":{\"mode\":\"always\"},\"page_load_timeout_ms\":1}", ConfigOptions)!;
                var engine = KreuzcrawlLib.CreateEngine(engineConfig);
