...
// alef:hash:6223c1ca29e2017a6cfa74e46f56c36535d3acdd7f39f9e737d5a8aecea56e5c
...
assertTrue(result.finalUrl().contains("/refreshed"), "expected to contain: " + "/refreshed");assertEquals(1, result.redirectCount());
    ...
    void testRedirectTo404() throws Exception {
        ...
        var result = Kreuzcrawl.scrape(engine, url);
assertTrue(result.finalUrl().contains("/gone"), "expected to contain: " + "/gone");assertEquals(1, result.redirectCount());assertEquals(true, result.isError());
    }
