...
// alef:hash:d99fc39a71fd986eeb873ea848273ff385c625134c8088f79576bd96282b4886
...
class BatchTest {
    ...
    void testBatchCrawlBasic() throws Exception {
        ...
        String urlsBase = System.getenv().getOrDefault("MOCK_SERVER_BATCH_CRAWL_BASIC", System.getenv("MOCK_SERVER_URL") + "/fixtures/batch_crawl_basic");
...
assertEquals(2, result.completedCount());assertEquals(0, result.failedCount());assertEquals(2, result.totalCount());
    ...
    void testBatchCrawlPartialFailure() throws Exception {
        ...
        var engineConfig = MAPPER.readValue("{\"max_depth\":1,\"respect_robots_txt\":false}", CrawlConfig.class);
        var engine = Kreuzcrawl.createEngine(engineConfig);
        String urlsBase = System.getenv().getOrDefault("MOCK_SERVER_BATCH_CRAWL_PARTIAL_FAILURE", System.getenv("MOCK_SERVER_URL") + "/fixtures/batch_crawl_partial_failure");
...
assertEquals(1, result.completedCount());assertEquals(1, result.failedCount());assertEquals(2, result.totalCount());
    ...
    void testBatchCrawlWithConfig() throws Exception {
        ...
        var engineConfig = MAPPER.readValue("{\"max_depth\":1,\"respect_robots_txt\":false}", CrawlConfig.class);
        var engine = Kreuzcrawl.createEngine(engineConfig);
        String urlsBase = System.getenv().getOrDefault("MOCK_SERVER_BATCH_CRAWL_WITH_CONFIG", System.getenv("MOCK_SERVER_URL") + "/fixtures/batch_crawl_with_config");
        java.util.List<String> urls = java.util.Arrays.stream(new String[]{"/seed1", "/seed2"}).map(p -> p.startsWith("http") ? p : urlsBase + p).collect(java.util.stream.Collectors.toList());
        var result = Kreuzcrawl.batchCrawl(engine, urls);
assertEquals(2, result.completedCount());assertEquals(0, result.failedCount());
    ...
    void testBatchScrapeEmptyUrlsError() throws Exception {
        ...
        assertThrows(Exception.class, () -> {
            ...
            String urlsBase = System.getenv().getOrDefault("MOCK_SERVER_BATCH_SCRAPE_EMPTY_URLS_ERROR", System.getenv("MOCK_SERVER_URL") + "/fixtures/batch_scrape_empty_urls_error");
    ...
    void testBatchScrapeWithConfig() throws Exception {
        ...
        var engine = Kreuzcrawl.createEngine(engineConfig);
        String urlsBase = System.getenv().getOrDefault("MOCK_SERVER_BATCH_SCRAPE_WITH_CONFIG", System.getenv("MOCK_SERVER_URL") + "/fixtures/batch_scrape_with_config");
...
assertEquals(2, result.completedCount());assertEquals(0, result.failedCount());assertEquals(2, result.totalCount());
    ...
    void testScrapeBatchBasic() throws Exception {
        ...
        var engine = Kreuzcrawl.createEngine(null);
        String urlsBase = System.getenv().getOrDefault("MOCK_SERVER_SCRAPE_BATCH_BASIC", System.getenv("MOCK_SERVER_URL") + "/fixtures/scrape_batch_basic");
...
assertEquals(3, result.completedCount());assertEquals(0, result.failedCount());assertEquals(3, result.totalCount());
    ...
    void testScrapeBatchPartialFailure() throws Exception {
        ...
        var engine = Kreuzcrawl.createEngine(null);
        String urlsBase = System.getenv().getOrDefault("MOCK_SERVER_SCRAPE_BATCH_PARTIAL_FAILURE", System.getenv("MOCK_SERVER_URL") + "/fixtures/scrape_batch_partial_failure");
...
assertEquals(2, result.completedCount());assertEquals(1, result.failedCount());assertEquals(3, result.totalCount());
    ...
    void testScrapeBatchProgress() throws Exception {
        ...
        var engine = Kreuzcrawl.createEngine(null);
        String urlsBase = System.getenv().getOrDefault("MOCK_SERVER_SCRAPE_BATCH_PROGRESS", System.getenv("MOCK_SERVER_URL") + "/fixtures/scrape_batch_progress");
        ...
        var result = Kreuzcrawl.batchScrape(engine, urls);
assertEquals(2, result.totalCount());assertTrue(result.results().toString().toLowerCase().contains(String.valueOf("/target").toLowerCase()), "expected to contain: " + "/target");
    }
