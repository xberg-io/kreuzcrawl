...
// alef:hash:8e443c98328ac7c251cca6c4384d982a3d7c1a7c50358636c7cf1b3ed948bb05
...
assertEquals(200, result.statusCode());
    ...
    void testCacheEtagConditional() throws Exception {
        ...
        String url = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL")) + "/fixtures/cache_etag_conditional";
        var result = Kreuzcrawl.scrape(engine, url);
    ...
    void testCacheLastModified() throws Exception {
        ...
        var engineConfig = MAPPER.readValue("{\"max_depth\":1}", CrawlConfig.class);
        var engine = Kreuzcrawl.createEngine(engineConfig);
        String url = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL")) + "/fixtures/cache_last_modified";
        var result = Kreuzcrawl.scrape(engine, url);
    ...
    void testCacheMissFreshFetch() throws Exception {
        ...
        var engineConfig = MAPPER.readValue("{\"max_depth\":1}", CrawlConfig.class);
        var engine = Kreuzcrawl.createEngine(engineConfig);
        String url = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL")) + "/fixtures/cache_miss_fresh_fetch";
        var result = Kreuzcrawl.scrape(engine, url);
        // skipped: field 'pages.length' not available on result typeassertEquals(200, result.statusCode());
    }
