...
// alef:hash:cd91ee4f16a16fc555e35a488a1dd55e1fe34ce0c67e7abd3794cbed17acd719
...
class EngineTest {
    ...
    void testEngineMapBasic() throws Exception {
        ...
        var engine = Kreuzcrawl.createEngine(null);
        String url = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL")) + "/fixtures/engine_map_basic";
        var result = Kreuzcrawl.scrape(engine, url);
