...
// alef:hash:6b8aa4aaf7223669fbb9c5d85caf9c805c25804e3b51e53db4e99266321c5b85
...
class MapTest {
    ...
    void testMapDiscoverUrls() throws Exception {
        ...
        String url = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL")) + "/fixtures/map_discover_urls";
...
assertTrue(result.urls().size() >= 3, "expected >= 3");
    ...
    void testMapExcludePatterns() throws Exception {
        ...
        var engine = Kreuzcrawl.createEngine(engineConfig);
        String url = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL")) + "/fixtures/map_exclude_patterns";
        var result = Kreuzcrawl.mapUrls(engine, url);
assertEquals(1, result.urls().size());
    ...
    void testMapIncludeSubdomains() throws Exception {
        ...
        var engine = Kreuzcrawl.createEngine(engineConfig);
        String url = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL")) + "/fixtures/map_include_subdomains";
        var result = Kreuzcrawl.mapUrls(engine, url);
assertTrue(result.urls().size() >= 2, "expected >= 2");assertTrue(result.urls().contains("blog.example.com"), "expected to contain: " + "blog.example.com");
    }
...
assertTrue(result.urls().size() >= 100, "expected >= 100");
    ...
    void testMapLimitPagination() throws Exception {
        ...
        var engine = Kreuzcrawl.createEngine(engineConfig);
        String url = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL")) + "/fixtures/map_limit_pagination";
        var result = Kreuzcrawl.mapUrls(engine, url);
assertTrue(result.urls().size() <= 5, "expected <= 5");
    ...
    void testMapSearchFilter() throws Exception {
        ...
        var engine = Kreuzcrawl.createEngine(engineConfig);
        String url = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL")) + "/fixtures/map_search_filter";
        var result = Kreuzcrawl.mapUrls(engine, url);
assertTrue(result.urls().size() >= 2, "expected >= 2");assertTrue(result.urls().contains("blog"), "expected to contain: " + "blog");
    }
