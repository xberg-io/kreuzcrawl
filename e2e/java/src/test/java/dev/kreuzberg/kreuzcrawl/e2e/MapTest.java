...
// alef:hash:dee0d93fbe986e631d613c5bf29195341ac9710bc87153ed3fef9040435f1760
...
assertEquals(1, result.urls().size());
    ...
    void testMapIncludeSubdomains() throws Exception {
        ...
        var result = Kreuzcrawl.mapUrls(engine, url);
assertTrue(result.urls().size() >= 2, "expected >= 2");assertTrue(result.urls().toString().toLowerCase().contains(String.valueOf("blog.example.com").toLowerCase()), "expected to contain: " + "blog.example.com");
    }
...
assertTrue(result.urls().size() <= 5, "expected <= 5");
    ...
    void testMapSearchFilter() throws Exception {
        ...
        var result = Kreuzcrawl.mapUrls(engine, url);
assertTrue(result.urls().size() >= 2, "expected >= 2");assertTrue(result.urls().toString().toLowerCase().contains(String.valueOf("blog").toLowerCase()), "expected to contain: " + "blog");
    }
