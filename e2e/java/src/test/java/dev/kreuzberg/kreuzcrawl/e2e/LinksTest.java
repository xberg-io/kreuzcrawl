...
// alef:hash:405d4392242bd0f7935601d2206d33798d92815c927d2c2ac381c5b293354b92
...
assertTrue(result.links().getFirst().linkType().getValue().contains("anchor"), "expected to contain: " + "anchor");
    ...
    void testLinksBaseTag() throws Exception {
        ...
        var result = Kreuzcrawl.scrape(engine, url);
assertTrue(result.links().size() > 2, "expected > 2");assertTrue(result.links().getFirst().url().contains("example.com"), "expected to contain: " + "example.com");
    }
...
assertTrue(result.links().getFirst().linkType().getValue().contains("document"), "expected to contain: " + "document");
    ...
    void testLinksEmptyHref() throws Exception {
        ...
        var result = Kreuzcrawl.scrape(engine, url);
assertTrue(result.links().size() > 0, "expected > 0");assertTrue(result.links().getFirst().url().contains("/valid"), "expected to contain: " + "/valid");
    }
    ...
    void testLinksInternalExternalClassification() throws Exception {
        ...
        var result = Kreuzcrawl.scrape(engine, url);
assertTrue(result.links().size() > 4, "expected > 4");assertFalse(result.links().getFirst().url().isEmpty(), "expected non-empty value");
    }
    ...
    void testLinksMailtoJavascriptSkip() throws Exception {
        ...
        var result = Kreuzcrawl.scrape(engine, url);
assertTrue(result.links().size() > 0, "expected > 0");assertFalse(result.links().getFirst().url().contains("mailto:"), "expected NOT to contain: " + "mailto:");
    }
    ...
    void testLinksProtocolRelative() throws Exception {
        ...
        var result = Kreuzcrawl.scrape(engine, url);
assertTrue(result.links().size() > 1, "expected > 1");assertTrue(result.links().getFirst().url().contains("//"), "expected to contain: " + "//");
    }
