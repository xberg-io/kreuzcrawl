...
// alef:hash:6cb904d62d6ff2da6923d2df94e61c5b9cbb12a547cdd818040f292db8735f7e
...
class ErrorTest {
    ...
    void testErrorBrowserLaunchFailure() throws Exception {
        ...
        // pattern.
        assertThrows(Exception.class, () -> {
            var engineConfig = MAPPER.readValue("{\"browser\":{\"mode\":\"always\"},\"browser_launch_timeout_ms\":1}", CrawlConfig.class);
    ...
    void testErrorBrowserPageTimeout() throws Exception {
        ...
        // pattern.
        assertThrows(Exception.class, () -> {
            var engineConfig = MAPPER.readValue("{\"browser\":{\"mode\":\"always\"},\"page_load_timeout_ms\":1}", CrawlConfig.class);
            var engine = Kreuzcrawl.createEngine(engineConfig);
...
assertTrue(result.html().isEmpty(), "expected empty value");assertEquals(false, result.isError());
    }
