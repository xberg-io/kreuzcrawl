...
// alef:hash:47e97ed186eea35b89efb58d6fd9015fac65a1b8c7a6bd04391cc0bdd5b47242
...
class ValidationTest {
    ...
    void testValidationEmptyBatchUrls() throws Exception {
        ...
        assertThrows(Exception.class, () -> {
            ...
            String url = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL")) + "/fixtures/validation_empty_batch_urls";
            Kreuzcrawl.scrape(engine, url);
        });
    }
