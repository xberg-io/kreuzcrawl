...
// alef:hash:13cb5fa80643c45c66b7ddacea500041840b3fda4dcb953ac3b556e2b5e4420b
...
assertEquals(204, result.statusCode());assertTrue(result.html().isEmpty(), "expected empty value");
    ...
    void testContentCharsetIso8859() throws Exception {
        ...
        var result = Kreuzcrawl.scrape(engine, url);
assertEquals("iso-8859-1", java.util.Optional.ofNullable(result.detectedCharset()).orElse("").trim());
    }
...
assertFalse(result.html().isEmpty(), "expected non-empty value");
    ...
    void testContentUtf8Bom() throws Exception {
        ...
        var result = Kreuzcrawl.scrape(engine, url);
assertEquals("utf-8", java.util.Optional.ofNullable(result.detectedCharset()).orElse("").trim());assertFalse(result.html().isEmpty(), "expected non-empty value");
    }
