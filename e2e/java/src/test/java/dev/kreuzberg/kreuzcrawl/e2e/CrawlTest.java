...
// alef:hash:2abcd20556924923aef3615137f956537452b4a9467640f8a51ea63eb9f3f59e
...
assertEquals(true, result.wasSkipped());
    ...
    void testCrawlConcurrentDepth() throws Exception {
        ...
        var engine = Kreuzcrawl.createEngine(engineConfig);
        String url = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL")) + "/fixtures/crawl_concurrent_depth";
        var result = Kreuzcrawl.scrape(engine, url);
    ...
    void testCrawlConcurrentLimit() throws Exception {
        ...
        var engine = Kreuzcrawl.createEngine(engineConfig);
        String url = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL")) + "/fixtures/crawl_concurrent_limit";
        var result = Kreuzcrawl.scrape(engine, url);
    ...
    void testCrawlConcurrentMaxPages() throws Exception {
        ...
        var engine = Kreuzcrawl.createEngine(engineConfig);
        String url = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL")) + "/fixtures/crawl_concurrent_max_pages";
        var result = Kreuzcrawl.scrape(engine, url);
        // skipped: field 'pages.length' not available on result type
    }
    ...
    void testCrawlCustomHeaders() throws Exception {
        ...
        var engine = Kreuzcrawl.createEngine(engineConfig);
        String url = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL")) + "/fixtures/crawl_custom_headers";
        var result = Kreuzcrawl.scrape(engine, url);
        // skipped: field 'pages.length' not available on result type
    }
    ...
    void testCrawlDepthOne() throws Exception {
        ...
        var engineConfig = MAPPER.readValue("{\"max_depth\":1,\"respect_robots_txt\":false}", CrawlConfig.class);
        var engine = Kreuzcrawl.createEngine(engineConfig);
        String url = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL")) + "/fixtures/crawl_depth_one";
        var result = Kreuzcrawl.scrape(engine, url);
        // skipped: field 'pages.length' not available on result type        // skipped: field 'stayed_on_domain' not available on result type
    }
    ...
    void testCrawlDepthPriority() throws Exception {
        ...
        var engine = Kreuzcrawl.createEngine(engineConfig);
        String url = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL")) + "/fixtures/crawl_depth_priority";
        var result = Kreuzcrawl.scrape(engine, url);
        // skipped: field 'pages.length' not available on result type
    }
    ...
    void testCrawlDepthTwo() throws Exception {
        ...
        var engineConfig = MAPPER.readValue("{\"max_depth\":2,\"respect_robots_txt\":false}", CrawlConfig.class);
        var engine = Kreuzcrawl.createEngine(engineConfig);
        String url = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL")) + "/fixtures/crawl_depth_two";
        var result = Kreuzcrawl.scrape(engine, url);
    ...
    void testCrawlDepthTwoChain() throws Exception {
        ...
        var engine = Kreuzcrawl.createEngine(engineConfig);
        String url = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL")) + "/fixtures/crawl_depth_two_chain";
        var result = Kreuzcrawl.scrape(engine, url);
        // skipped: field 'pages.length' not available on result type
    }
    ...
    void testCrawlDoubleSlashNormalization() throws Exception {
        ...
        var engineConfig = MAPPER.readValue("{\"max_depth\":1,\"respect_robots_txt\":false}", CrawlConfig.class);
        var engine = Kreuzcrawl.createEngine(engineConfig);
        String url = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL")) + "/fixtures/crawl_double_slash_normalization";
        var result = Kreuzcrawl.scrape(engine, url);
    ...
    void testCrawlEmptyPageNoLinks() throws Exception {
        ...
        var engineConfig = MAPPER.readValue("{\"max_concurrent\":1,\"max_depth\":2}", CrawlConfig.class);
        var engine = Kreuzcrawl.createEngine(engineConfig);
        String url = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL")) + "/fixtures/crawl_empty_page_no_links";
        var result = Kreuzcrawl.scrape(engine, url);
        // skipped: field 'pages.length' not available on result type
    }
    ...
    void testCrawlExcludePathPattern() throws Exception {
        ...
        var engine = Kreuzcrawl.createEngine(engineConfig);
        String url = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL")) + "/fixtures/crawl_exclude_path_pattern";
        var result = Kreuzcrawl.scrape(engine, url);
        // skipped: field 'pages.length' not available on result type
    }
    ...
    void testCrawlExternalLinksIgnored() throws Exception {
        ...
        var engine = Kreuzcrawl.createEngine(engineConfig);
        String url = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL")) + "/fixtures/crawl_external_links_ignored";
        var result = Kreuzcrawl.scrape(engine, url);
        // skipped: field 'pages.length' not available on result type        // skipped: field 'stayed_on_domain' not available on result type
    }
    ...
    void testCrawlFragmentStripping() throws Exception {
        ...
        var engineConfig = MAPPER.readValue("{\"max_depth\":1,\"respect_robots_txt\":false}", CrawlConfig.class);
        var engine = Kreuzcrawl.createEngine(engineConfig);
        String url = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL")) + "/fixtures/crawl_fragment_stripping";
        var result = Kreuzcrawl.scrape(engine, url);
        // skipped: field 'unique_urls.length' not available on result type
    }
    ...
    void testCrawlIncludePathPattern() throws Exception {
        ...
        var engine = Kreuzcrawl.createEngine(engineConfig);
        String url = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL")) + "/fixtures/crawl_include_path_pattern";
        var result = Kreuzcrawl.scrape(engine, url);
        // skipped: field 'pages.length' not available on result type
    }
    ...
    void testCrawlMaxDepthZero() throws Exception {
        ...
        var engine = Kreuzcrawl.createEngine(engineConfig);
        String url = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL")) + "/fixtures/crawl_max_depth_zero";
        var result = Kreuzcrawl.scrape(engine, url);
        // skipped: field 'pages.length' not available on result type        // skipped: field 'pages.length' not available on result type
    }
    ...
    void testCrawlMaxPages() throws Exception {
        ...
        var engine = Kreuzcrawl.createEngine(engineConfig);
        String url = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL")) + "/fixtures/crawl_max_pages";
        var result = Kreuzcrawl.scrape(engine, url);
        // skipped: field 'pages.length' not available on result type
    }
    ...
    void testCrawlMixedContentTypes() throws Exception {
        ...
        var engine = Kreuzcrawl.createEngine(engineConfig);
        String url = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL")) + "/fixtures/crawl_mixed_content_types";
        var result = Kreuzcrawl.scrape(engine, url);
        // skipped: field 'pages.length' not available on result type
    }
    ...
    void testCrawlMultipleRedirectsInTraversal() throws Exception {
        ...
        var engineConfig = MAPPER.readValue("{\"max_concurrent\":1,\"max_depth\":1}", CrawlConfig.class);
        var engine = Kreuzcrawl.createEngine(engineConfig);
        String url = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL")) + "/fixtures/crawl_multiple_redirects_in_traversal";
        var result = Kreuzcrawl.scrape(engine, url);
        // skipped: field 'pages.length' not available on result type
    }
    ...
    void testCrawlQueryParamDedup() throws Exception {
        ...
        var engineConfig = MAPPER.readValue("{\"max_depth\":1,\"respect_robots_txt\":false}", CrawlConfig.class);
        var engine = Kreuzcrawl.createEngine(engineConfig);
        String url = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL")) + "/fixtures/crawl_query_param_dedup";
        var result = Kreuzcrawl.scrape(engine, url);
        // skipped: field 'unique_urls.length' not available on result type
    }
    ...
    void testCrawlRedirectInTraversal() throws Exception {
        ...
        var engineConfig = MAPPER.readValue("{\"max_concurrent\":1,\"max_depth\":1}", CrawlConfig.class);
        var engine = Kreuzcrawl.createEngine(engineConfig);
        String url = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL")) + "/fixtures/crawl_redirect_in_traversal";
        var result = Kreuzcrawl.scrape(engine, url);
        // skipped: field 'pages.length' not available on result type
    }
    ...
    void testCrawlSelfLinkNoLoop() throws Exception {
        ...
        var engineConfig = MAPPER.readValue("{\"max_concurrent\":1,\"max_depth\":1}", CrawlConfig.class);
        var engine = Kreuzcrawl.createEngine(engineConfig);
        String url = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL")) + "/fixtures/crawl_self_link_no_loop";
        var result = Kreuzcrawl.scrape(engine, url);
        // skipped: field 'pages.length' not available on result type
    }
    ...
    void testCrawlStayOnDomain() throws Exception {
        ...
        var engine = Kreuzcrawl.createEngine(engineConfig);
        String url = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL")) + "/fixtures/crawl_stay_on_domain";
        var result = Kreuzcrawl.scrape(engine, url);
        // skipped: field 'pages.length' not available on result type        // skipped: field 'stayed_on_domain' not available on result type
    }
    ...
    void testCrawlSubdomainExclusion() throws Exception {
        ...
        var engine = Kreuzcrawl.createEngine(engineConfig);
        String url = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL")) + "/fixtures/crawl_subdomain_exclusion";
        var result = Kreuzcrawl.scrape(engine, url);
        // skipped: field 'pages.length' not available on result type        // skipped: field 'stayed_on_domain' not available on result type
    }
    ...
    void testCrawlSubdomainInclusion() throws Exception {
        ...
        var engine = Kreuzcrawl.createEngine(engineConfig);
        String url = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL")) + "/fixtures/crawl_subdomain_inclusion";
        var result = Kreuzcrawl.scrape(engine, url);
        // skipped: field 'pages.length' not available on result type
    }
    ...
    void testCrawlTrailingSlashDedup() throws Exception {
        ...
        var engineConfig = MAPPER.readValue("{\"max_depth\":1,\"respect_robots_txt\":false}", CrawlConfig.class);
        var engine = Kreuzcrawl.createEngine(engineConfig);
        String url = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL")) + "/fixtures/crawl_trailing_slash_dedup";
        var result = Kreuzcrawl.scrape(engine, url);
        // skipped: field 'unique_urls.length' not available on result type
    }
    ...
    void testCrawlUrlDeduplication() throws Exception {
        ...
        var engineConfig = MAPPER.readValue("{\"max_depth\":1,\"respect_robots_txt\":false}", CrawlConfig.class);
        var engine = Kreuzcrawl.createEngine(engineConfig);
        String url = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL")) + "/fixtures/crawl_url_deduplication";
        var result = Kreuzcrawl.scrape(engine, url);
        // skipped: field 'pages.length' not available on result type
    }
