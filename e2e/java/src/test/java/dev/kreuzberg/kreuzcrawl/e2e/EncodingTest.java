...
// alef:hash:be655faee8ba80d99c24705f9e5bbd6f579c97b153ade576c89cf90fe0d6ec01
...
class EncodingTest {
    ...
    void testEncodingDoubleEncoded() throws Exception {
        ...
        String url = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL")) + "/fixtures/encoding_double_encoded";
...
assertFalse(result.html().isEmpty(), "expected non-empty value");
    ...
    void testEncodingPercentEncodedPath() throws Exception {
        ...
        var engine = Kreuzcrawl.createEngine(null);
        String url = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL")) + "/fixtures/encoding_percent_encoded_path";
        var result = Kreuzcrawl.scrape(engine, url);
