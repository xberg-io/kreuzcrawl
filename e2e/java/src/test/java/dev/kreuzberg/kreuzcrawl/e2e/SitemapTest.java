...
// alef:hash:147bcd895d460a8d430bff49e56d2cf0180371e19e4230aa1ad828843d08b5fb
...
assertEquals(4, result.urls().size());assertEquals(true, result.hasLastmod());
    }
...
assertEquals(4, result.urls().size());
    ...
    void testSitemapXhtmlLinks() throws Exception {
        ...
        var result = Kreuzcrawl.scrape(engine, url);
assertEquals(2, result.urls().size());assertEquals(false, result.hasLastmod());
    }
