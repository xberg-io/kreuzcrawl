...
// alef:hash:fa9ed8be61ddb9acfca991a80749eb0e012c499e8cb5b61ad8e24bad80f1dc0f
...
class SitemapTest {
    ...
    void testSitemapFromRobotsTxt() throws Exception {
        ...
        var engine = Kreuzcrawl.createEngine(engineConfig);
        String url = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL")) + "/fixtures/sitemap_from_robots_txt";
        var result = Kreuzcrawl.scrape(engine, url);
        // skipped: field 'urls.length' not available on result type
    }
    ...
    void testSitemapIndex() throws Exception {
        ...
        var engine = Kreuzcrawl.createEngine(null);
        String url = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL")) + "/fixtures/sitemap_index";
        var result = Kreuzcrawl.scrape(engine, url);
        // skipped: field 'urls.length' not available on result type
    }
