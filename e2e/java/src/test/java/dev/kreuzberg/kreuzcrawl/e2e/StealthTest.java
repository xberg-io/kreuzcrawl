...
// alef:hash:35b6ec78f163f0bf8507448acf00bf70690b4455a588677b356ee1616067e780
...
assertEquals(200, result.statusCode());
    ...
    void testStealthUaRotationRoundRobin() throws Exception {
        ...
        var engine = Kreuzcrawl.createEngine(engineConfig);
        String url = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL")) + "/fixtures/stealth_ua_rotation_round_robin";
        var result = Kreuzcrawl.scrape(engine, url);
