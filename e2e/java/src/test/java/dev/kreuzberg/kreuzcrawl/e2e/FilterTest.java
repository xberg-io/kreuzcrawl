...
// alef:hash:84a05d1280a5f0d935d9cd25c1307415135adc35888e379136debf6fce66ebc3
...
class FilterTest {
    ...
    void testFilterBm25CrawlIntegration() throws Exception {
        ...
        String url = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL")) + "/fixtures/filter_bm25_crawl_integration";
    ...
    void testFilterBm25EmptyQuery() throws Exception {
        ...
        var engine = Kreuzcrawl.createEngine(engineConfig);
        String url = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL")) + "/fixtures/filter_bm25_empty_query";
        var result = Kreuzcrawl.crawl(engine, url);
assertEquals(2, result.pages().size(), "expected exactly 2 elements");
    ...
    void testFilterBm25HighThreshold() throws Exception {
        ...
        var engineConfig = MAPPER.readValue("{\"max_depth\":1}", CrawlConfig.class);
        var engine = Kreuzcrawl.createEngine(engineConfig);
        String url = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL")) + "/fixtures/filter_bm25_high_threshold";
    ...
    void testFilterBm25RelevantPages() throws Exception {
        ...
        var engineConfig = MAPPER.readValue("{\"max_depth\":1}", CrawlConfig.class);
        var engine = Kreuzcrawl.createEngine(engineConfig);
        String url = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL")) + "/fixtures/filter_bm25_relevant_pages";
        var result = Kreuzcrawl.scrape(engine, url);
        // skipped: field 'filter.remaining_contain_keyword' not available on result type
    }
    ...
    void testFilterBm25ThresholdZero() throws Exception {
        ...
        var engineConfig = MAPPER.readValue("{\"max_depth\":1}", CrawlConfig.class);
        var engine = Kreuzcrawl.createEngine(engineConfig);
        String url = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL")) + "/fixtures/filter_bm25_threshold_zero";
        var result = Kreuzcrawl.crawl(engine, url);
assertEquals(2, result.pages().size(), "expected exactly 2 elements");
    }
    ...
    void testFilterNoopCrawlAllKept() throws Exception {
        ...
        var engineConfig = MAPPER.readValue("{\"max_concurrent\":1,\"max_depth\":1}", CrawlConfig.class);
        var engine = Kreuzcrawl.createEngine(engineConfig);
        String url = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL")) + "/fixtures/filter_noop_crawl_all_kept";
        var result = Kreuzcrawl.crawl(engine, url);
        // skipped: field 'filter.pages_after_filter' not available on result type
    }
    ...
    void testFilterNoopPassesAll() throws Exception {
        ...
        var engineConfig = MAPPER.readValue("{\"max_depth\":1}", CrawlConfig.class);
        var engine = Kreuzcrawl.createEngine(engineConfig);
        String url = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL")) + "/fixtures/filter_noop_passes_all";
        var result = Kreuzcrawl.crawl(engine, url);
