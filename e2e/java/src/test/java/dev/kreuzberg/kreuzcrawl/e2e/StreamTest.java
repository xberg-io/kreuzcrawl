...
public class StreamTest {
  ...
  void testBatchCrawlStreamEvents() throws Exception {
    ...
    String urlsBase = System.getProperty(
        "mockServer.batch_crawl_stream_events",
        System.getenv()
            .getOrDefault(
  ...
  void testBatchCrawlStreamPartialFailure() throws Exception {
    ...
    var engine = Kreuzcrawl.createEngine(engineConfig);
    String urlsBase = System.getProperty(
        "mockServer.batch_crawl_stream_partial_failure",
        System.getenv()
            .getOrDefault(
    ...
    java.util.List<String> urls = java.util.Arrays.stream(
            new String[] {"/success1", "/fail", "/success2"})
        .map(p -> p.startsWith("http") ? p : urlsBase + p)
        .collect(java.util.stream.Collectors.toList());
    var urlsReq = new BatchCrawlStreamRequest(urls);
    var result = engine.batchCrawlStream(urlsReq);
  ...
  void testCrawlStreamEvents() throws Exception {
    ...
    String url = System.getProperty(
        "mockServer.crawl_stream_events",
  ...
  void testStreamErrorEventMidCrawl() throws Exception {
    ...
    var engine = Kreuzcrawl.createEngine(engineConfig);
    String url = System.getProperty(
        "mockServer.stream_error_event_mid_crawl",
        System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL"))
  ...
  void testStreamEventOrdering() throws Exception {
    ...
    var engine = Kreuzcrawl.createEngine(engineConfig);
    String url = System.getProperty(
        "mockServer.stream_event_ordering",
        System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL"))
  ...
  void testStreamWithErrorEvent() throws Exception {
    ...
    var engine = Kreuzcrawl.createEngine(engineConfig);
    String url = System.getProperty(
        "mockServer.stream_with_error_event",
        System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL"))
