...
// alef:hash:92861307c1b1b901cc0baeddd8c52915655a87b6089e53aada00f8f571bc43b5
...
test "sitemap_basic" {
    ...
    try testing.expectEqual(true, result.object.get("has_lastmod").?.bool);
}
...
test "sitemap_xhtml_links" {
    ...
    try testing.expectEqual(false, result.object.get("has_lastmod").?.bool);
}
