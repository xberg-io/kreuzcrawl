...
// alef:hash:078a7c6abf6e76abb6360915889c9144399224415d1774b17ce659558fc33a5d
...
test "metadata_keywords_author" {
    ...
    try testing.expectEqualStrings("kreuzcrawl/1.0", result.object.get("metadata").?.object.get("generator").?.string);
