...
// alef:hash:7436919a17cea2db33839c73690fad849dc2ca15e09d9b8688b23ca4b42ae857
...
test "rate_limit_robots_crawl_delay" {
    ...
    defer allocator.free(url);
    const _result_json = try kreuzcrawl.scrape("{\"max_depth\":1,\"respect_robots_txt\":true,\"user_agent\":\"TestBot\"}", url);
    defer std.heap.c_allocator.free(_result_json);
    var _parsed = try std.json.parseFromSlice(std.json.Value, allocator, _result_json, .{});
    defer _parsed.deinit();
    const result = &_parsed.value;
