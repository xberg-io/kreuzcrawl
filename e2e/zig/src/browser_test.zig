...
// alef:hash:572abd69d8f9c02c4494e70dfecaca33e8e127f8183b259b03a652bea0db39e8
...
test "browser_config_auto_no_feature" {
    ...
    try testing.expectEqual(true, result.object.get("browser").?.object.get("js_render_hint").?.bool);
    try testing.expectEqual(false, result.object.get("browser").?.object.get("browser_used").?.bool);
}
...
test "browser_crawl_mode_always" {
    ...
    try testing.expectEqual(true, result.object.get("browser").?.object.get("browser_used").?.bool);
}
...
test "browser_detect_minimal_page" {
    ...
    const result = &_parsed.value;
    try testing.expectEqual(200, result.object.get("status_code").?.integer);
    try testing.expectEqual(false, result.object.get("browser").?.object.get("js_render_hint").?.bool);
    try testing.expectEqual(false, result.object.get("browser").?.object.get("browser_used").?.bool);
}
