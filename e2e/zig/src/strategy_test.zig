...
// alef:hash:2aa2dc4e77671bfaf230192497588531b5a13805a23b993b9e665db4136b83e1
...
test "strategy_adaptive_saturation" {
    ...
    try testing.expect(result.object.get("pages").?.integer >= 1);
}
...
test "strategy_adaptive_window" {
    ...
    defer _parsed.deinit();
    const result = &_parsed.value;
    try testing.expect(result.object.get("pages").?.integer >= 3);
}
