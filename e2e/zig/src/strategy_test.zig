...
// alef:hash:dde1ad3d9a55a63cfe9430721fb7cb58fa3f3def6e2e8728ede835c5be62e13d
...
test "strategy_adaptive_saturation" {
    ...
    const _result_json = try kreuzcrawl.scrape("{\"max_concurrent\":1,\"max_depth\":2,\"respect_robots_txt\":false}", url);
...
test "strategy_adaptive_window" {
    ...
    defer allocator.free(url);
    const _result_json = try kreuzcrawl.scrape("{\"max_concurrent\":1,\"max_depth\":1,\"respect_robots_txt\":false}", url);
    defer std.heap.c_allocator.free(_result_json);
}
