...
// alef:hash:406f5b8059e15c8ef88fefcbb6605e9bae72155bcc54136fd28980c0d6e607cb
...
func Test_FilterBm25CrawlIntegration(t *testing.T) {
	...
	if url == "" { url = os.Getenv("MOCK_SERVER_URL") + "/fixtures/filter_bm25_crawl_integration" }
...
func Test_FilterBm25EmptyQuery(t *testing.T) {
	...
	if url == "" { url = os.Getenv("MOCK_SERVER_URL") + "/fixtures/filter_bm25_empty_query" }
...
func Test_FilterBm25HighThreshold(t *testing.T) {
	...
	if url == "" { url = os.Getenv("MOCK_SERVER_URL") + "/fixtures/filter_bm25_high_threshold" }
...
func Test_FilterBm25RelevantPages(t *testing.T) {
	...
	if url == "" { url = os.Getenv("MOCK_SERVER_URL") + "/fixtures/filter_bm25_relevant_pages" }
	_, err := pkg.Scrape(engine, url)
	if err != nil {
		t.Fatalf("call failed: %v", err)
	}
...
func Test_FilterBm25ThresholdZero(t *testing.T) {
	...
	if url == "" { url = os.Getenv("MOCK_SERVER_URL") + "/fixtures/filter_bm25_threshold_zero" }
	result, err := pkg.Crawl(engine, url)
	if err != nil {
		t.Fatalf("call failed: %v", err)
	}
...
func Test_FilterNoopCrawlAllKept(t *testing.T) {
	...
	if url == "" { url = os.Getenv("MOCK_SERVER_URL") + "/fixtures/filter_noop_crawl_all_kept" }
	_, err := pkg.Crawl(engine, url)
	if err != nil {
		t.Fatalf("call failed: %v", err)
	}
...
func Test_FilterNoopPassesAll(t *testing.T) {
	...
	if url == "" { url = os.Getenv("MOCK_SERVER_URL") + "/fixtures/filter_noop_passes_all" }
	result, err := pkg.Crawl(engine, url)
	if err != nil {
		t.Fatalf("call failed: %v", err)
	}
