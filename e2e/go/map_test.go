...
// alef:hash:b802b27017a0defd09f2a162003a2fcbda576d8e34b7a499ad963bdf6a667082
...
func Test_MapIncludeSubdomains(t *testing.T) {
	...
	if !strings.Contains(fmt.Sprint(result.Urls), `blog.example.com`) {
...
func Test_MapSearchFilter(t *testing.T) {
	...
	if !strings.Contains(fmt.Sprint(result.Urls), `blog`) {
