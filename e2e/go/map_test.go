...
func Test_MapDiscoverUrls(t *testing.T) {
	...
	if url == "" { url = os.Getenv("MOCK_SERVER_URL") + "/fixtures/map_discover_urls" }
...
func Test_MapExcludePatterns(t *testing.T) {
	...
	if url == "" { url = os.Getenv("MOCK_SERVER_URL") + "/fixtures/map_exclude_patterns" }
	result, err := pkg.MapUrls(engine, url)
	if err != nil {
		t.Fatalf("call failed: %v", err)
	}
...
func Test_MapIncludeSubdomains(t *testing.T) {
	...
	if url == "" { url = os.Getenv("MOCK_SERVER_URL") + "/fixtures/map_include_subdomains" }
	result, err := pkg.MapUrls(engine, url)
	if err != nil {
		t.Fatalf("call failed: %v", err)
	}
...
func Test_MapLimitPagination(t *testing.T) {
	...
	if url == "" { url = os.Getenv("MOCK_SERVER_URL") + "/fixtures/map_limit_pagination" }
	result, err := pkg.MapUrls(engine, url)
	if err != nil {
		t.Fatalf("call failed: %v", err)
	}
...
func Test_MapSearchFilter(t *testing.T) {
	...
	if url == "" { url = os.Getenv("MOCK_SERVER_URL") + "/fixtures/map_search_filter" }
	result, err := pkg.MapUrls(engine, url)
	if err != nil {
		t.Fatalf("call failed: %v", err)
	}
