...
// alef:hash:5b54290e285c7c9ef854ede780a44deb2c720162e8605603f6c181c468cc4c2a
...
func Test_ScrapeAssetTypeFilter(t *testing.T) {
	...
	if len(result.Assets) > 0 {
		if !strings.Contains(fmt.Sprint(result.Assets[0].AssetCategory), `image`) {
...
func Test_ScrapeBasicHtmlPage(t *testing.T) {
	...
	if result.Metadata.Title != nil {
		metadataTitle = fmt.Sprintf("%v", *result.Metadata.Title)
	}
	var metadataDescription string
	if result.Metadata.Description != nil {
		metadataDescription = fmt.Sprintf("%v", *result.Metadata.Description)
	}
	if result.StatusCode != 200 {
		t.Errorf("equals mismatch: got %v", result.StatusCode)
	}
	...
	if !strings.Contains(fmt.Sprint(metadataDescription), `illustrative examples`) {
	...
	if len(result.Links) > 0 {
		if !strings.Contains(fmt.Sprint(result.Links[0].LinkType), `external`) {
...
func Test_ScrapeDublinCore(t *testing.T) {
	...
	if result.Metadata.DcTitle != nil {
		metadataDcTitle = fmt.Sprintf("%v", *result.Metadata.DcTitle)
	}
	var metadataDcCreator string
	if result.Metadata.DcCreator != nil {
		metadataDcCreator = fmt.Sprintf("%v", *result.Metadata.DcCreator)
	}
	if result.StatusCode != 200 {
		t.Errorf("equals mismatch: got %v", result.StatusCode)
	}
...
func Test_ScrapeImageSources(t *testing.T) {
	...
	if result.Metadata.OgImage != nil {
		metadataOgImage = fmt.Sprintf("%v", *result.Metadata.OgImage)
	}
	if result.StatusCode != 200 {
		t.Errorf("equals mismatch: got %v", result.StatusCode)
	}
...
func Test_ScrapeJsonLd(t *testing.T) {
	...
	if result.JSONLd[0].Name != nil {
		jsonLdName = fmt.Sprintf("%v", *result.JSONLd[0].Name)
	}
	if result.StatusCode != 200 {
		t.Errorf("equals mismatch: got %v", result.StatusCode)
	}
...
func Test_ScrapeMalformedHtml(t *testing.T) {
	...
	if !strings.Contains(fmt.Sprint(metadataDescription), `broken HTML`) {
...
func Test_ScrapeOgMetadata(t *testing.T) {
	...
	if result.Metadata.OgTitle != nil {
		metadataOgTitle = fmt.Sprintf("%v", *result.Metadata.OgTitle)
	}
	var metadataOgType string
	if result.Metadata.OgType != nil {
		metadataOgType = fmt.Sprintf("%v", *result.Metadata.OgType)
	}
	var metadataOgImage string
	if result.Metadata.OgImage != nil {
		metadataOgImage = fmt.Sprintf("%v", *result.Metadata.OgImage)
...
func Test_ScrapeTwitterCard(t *testing.T) {
	...
	if result.Metadata.TwitterCard != nil {
		metadataTwitterCard = fmt.Sprintf("%v", *result.Metadata.TwitterCard)
	}
	var metadataTwitterTitle string
	if result.Metadata.TwitterTitle != nil {
		metadataTwitterTitle = fmt.Sprintf("%v", *result.Metadata.TwitterTitle)
	}
	if result.StatusCode != 200 {
		t.Errorf("equals mismatch: got %v", result.StatusCode)
	}
