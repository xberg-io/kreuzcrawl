...
func Test_ScrapeAssetDedup(t *testing.T) {
	...
	if url == "" { url = os.Getenv("MOCK_SERVER_URL") + "/fixtures/scrape_asset_dedup" }
...
func Test_ScrapeAssetMaxSize(t *testing.T) {
	...
	if url == "" { url = os.Getenv("MOCK_SERVER_URL") + "/fixtures/scrape_asset_max_size" }
	result, err := pkg.Scrape(engine, url)
	if err != nil {
		t.Fatalf("call failed: %v", err)
	}
...
func Test_ScrapeAssetTypeFilter(t *testing.T) {
	...
	if url == "" { url = os.Getenv("MOCK_SERVER_URL") + "/fixtures/scrape_asset_type_filter" }
	result, err := pkg.Scrape(engine, url)
	if err != nil {
		t.Fatalf("call failed: %v", err)
	}
...
func Test_ScrapeDownloadAssets(t *testing.T) {
	...
	if url == "" { url = os.Getenv("MOCK_SERVER_URL") + "/fixtures/scrape_download_assets" }
	result, err := pkg.Scrape(engine, url)
	if err != nil {
		t.Fatalf("call failed: %v", err)
	}
