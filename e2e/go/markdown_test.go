...
// alef:hash:953eb0c3014c408857e2302517552e21c32587455b3f6611b525434bb0266387
...
func Test_CitationsBalancedParens(t *testing.T) {
	...
	if !strings.Contains(fmt.Sprint(result.Markdown.Content), `(`) {
...
func Test_CitationsDuplicateUrls(t *testing.T) {
	...
	if result.Markdown.Citations != nil {
