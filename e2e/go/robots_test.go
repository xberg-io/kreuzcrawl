...
func Test_RobotsAllowAll(t *testing.T) {
	...
	if url == "" { url = os.Getenv("MOCK_SERVER_URL") + "/fixtures/robots_allow_all" }
...
func Test_RobotsAllowOverride(t *testing.T) {
	...
	if url == "" { url = os.Getenv("MOCK_SERVER_URL") + "/fixtures/robots_allow_override" }
	result, err := pkg.Scrape(engine, url)
	if err != nil {
		t.Fatalf("call failed: %v", err)
	}
...
func Test_RobotsCommentsHandling(t *testing.T) {
	...
	if url == "" { url = os.Getenv("MOCK_SERVER_URL") + "/fixtures/robots_comments_handling" }
	result, err := pkg.Scrape(engine, url)
	if err != nil {
		t.Fatalf("call failed: %v", err)
	}
...
func Test_RobotsCrawlDelay(t *testing.T) {
	...
	if url == "" { url = os.Getenv("MOCK_SERVER_URL") + "/fixtures/robots_crawl_delay" }
	result, err := pkg.Scrape(engine, url)
	if err != nil {
		t.Fatalf("call failed: %v", err)
	}
...
func Test_RobotsDisallowPath(t *testing.T) {
	...
	if url == "" { url = os.Getenv("MOCK_SERVER_URL") + "/fixtures/robots_disallow_path" }
	result, err := pkg.Scrape(engine, url)
	if err != nil {
		t.Fatalf("call failed: %v", err)
	}
...
func Test_RobotsMetaNofollow(t *testing.T) {
	...
	if url == "" { url = os.Getenv("MOCK_SERVER_URL") + "/fixtures/robots_meta_nofollow" }
	result, err := pkg.Scrape(engine, url)
	if err != nil {
		t.Fatalf("call failed: %v", err)
	}
...
func Test_RobotsMetaNoindex(t *testing.T) {
	...
	if url == "" { url = os.Getenv("MOCK_SERVER_URL") + "/fixtures/robots_meta_noindex" }
	result, err := pkg.Scrape(engine, url)
	if err != nil {
		t.Fatalf("call failed: %v", err)
	}
...
func Test_RobotsMissing404(t *testing.T) {
	...
	if url == "" { url = os.Getenv("MOCK_SERVER_URL") + "/fixtures/robots_missing_404" }
	result, err := pkg.Scrape(engine, url)
	if err != nil {
		t.Fatalf("call failed: %v", err)
	}
...
func Test_RobotsMultipleUserAgents(t *testing.T) {
	...
	if url == "" { url = os.Getenv("MOCK_SERVER_URL") + "/fixtures/robots_multiple_user_agents" }
	result, err := pkg.Scrape(engine, url)
	if err != nil {
		t.Fatalf("call failed: %v", err)
	}
...
func Test_RobotsRequestRate(t *testing.T) {
	...
	if url == "" { url = os.Getenv("MOCK_SERVER_URL") + "/fixtures/robots_request_rate" }
	result, err := pkg.Scrape(engine, url)
	if err != nil {
		t.Fatalf("call failed: %v", err)
	}
...
func Test_RobotsSitemapDirective(t *testing.T) {
	...
	if url == "" { url = os.Getenv("MOCK_SERVER_URL") + "/fixtures/robots_sitemap_directive" }
	result, err := pkg.Scrape(engine, url)
	if err != nil {
		t.Fatalf("call failed: %v", err)
	}
...
func Test_RobotsUserAgentSpecific(t *testing.T) {
	...
	if url == "" { url = os.Getenv("MOCK_SERVER_URL") + "/fixtures/robots_user_agent_specific" }
	result, err := pkg.Scrape(engine, url)
	if err != nil {
		t.Fatalf("call failed: %v", err)
	}
...
func Test_RobotsWildcardPaths(t *testing.T) {
	...
	if url == "" { url = os.Getenv("MOCK_SERVER_URL") + "/fixtures/robots_wildcard_paths" }
	result, err := pkg.Scrape(engine, url)
	if err != nil {
		t.Fatalf("call failed: %v", err)
	}
...
func Test_RobotsXRobotsTag(t *testing.T) {
	...
	if url == "" { url = os.Getenv("MOCK_SERVER_URL") + "/fixtures/robots_x_robots_tag" }
	result, err := pkg.Scrape(engine, url)
	if err != nil {
		t.Fatalf("call failed: %v", err)
	}
