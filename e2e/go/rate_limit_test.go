...
func Test_RateLimitBasicDelay(t *testing.T) {
	...
	if url == "" { url = os.Getenv("MOCK_SERVER_URL") + "/fixtures/rate_limit_basic_delay" }
...
func Test_RateLimitPerDomain(t *testing.T) {
	...
	if url == "" { url = os.Getenv("MOCK_SERVER_URL") + "/fixtures/rate_limit_per_domain" }
	result, err := pkg.Crawl(engine, url)
	if err != nil {
		t.Fatalf("call failed: %v", err)
	}
...
func Test_RateLimitRobotsCrawlDelay(t *testing.T) {
	...
	if url == "" { url = os.Getenv("MOCK_SERVER_URL") + "/fixtures/rate_limit_robots_crawl_delay" }
	result, err := pkg.Crawl(engine, url)
	if err != nil {
		t.Fatalf("call failed: %v", err)
	}
...
func Test_RateLimitZeroNoDelay(t *testing.T) {
	...
	if url == "" { url = os.Getenv("MOCK_SERVER_URL") + "/fixtures/rate_limit_zero_no_delay" }
	result, err := pkg.Crawl(engine, url)
	if err != nil {
		t.Fatalf("call failed: %v", err)
	}
