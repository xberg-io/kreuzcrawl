...
// alef:hash:35e99dbbbf274cd6cf68e2434b0c068186b4e0e39367d87129b5da6c34414cf5
...
func Test_BrowserConfigAutoNoFeature(t *testing.T) {
	...
	if result.Browser.JsRenderHint != true {
		t.Errorf("equals mismatch: got %v", result.Browser.JsRenderHint)
	}
	if result.Browser.BrowserUsed != false {
		t.Errorf("equals mismatch: got %v", result.Browser.BrowserUsed)
	}
}
...
func Test_BrowserDetectMinimalPage(t *testing.T) {
	...
	if result.Browser.JsRenderHint != false {
		t.Errorf("equals mismatch: got %v", result.Browser.JsRenderHint)
	}
	if result.Browser.BrowserUsed != false {
		t.Errorf("equals mismatch: got %v", result.Browser.BrowserUsed)
...
func Test_BrowserExtraWait(t *testing.T) {
	...
	if result.Browser.BrowserUsed != true {
		t.Errorf("equals mismatch: got %v", result.Browser.BrowserUsed)
	}
}
