...
// alef:hash:5013c7a8ea679e9e7d0457f30bb85dae59228462161264818bd18a9743cd4d24
...
async fn test_interact_max_actions_exceeded() {
    ...
    assert!(
        result.as_ref().unwrap_err().to_string().contains("actions"),
