...
async fn test_validation_empty_batch_urls() {
    ...
    let url = format!("{}/fixtures/{}", std::env::var("MOCK_SERVER_URL").expect("MOCK_SERVER_URL not set"), "validation_empty_batch_urls");
    let result = scrape(&engine, &url).await;
    assert!(result.is_err(), "expected call to fail");
    assert!(result.as_ref().unwrap_err().to_string().contains("urls"), "error message mismatch");
}
...
async fn test_validation_invalid_auth_config() {
    ...
    let url = format!("{}/fixtures/{}", std::env::var("MOCK_SERVER_URL").expect("MOCK_SERVER_URL not set"), "validation_invalid_auth_config");
    let result = scrape(&engine, &url).await;
    assert!(result.is_err(), "expected call to fail");
    assert!(result.as_ref().unwrap_err().to_string().contains("auth"), "error message mismatch");
}
...
async fn test_validation_invalid_proxy_url() {
    ...
    let engine = create_engine(Some(engine_config)).expect("handle creation should succeed");
    let url = format!("{}/fixtures/{}", std::env::var("MOCK_SERVER_URL").expect("MOCK_SERVER_URL not set"), "validation_invalid_proxy_url");
    let result = scrape(&engine, &url).await;
    assert!(result.is_err(), "expected call to fail");
    assert!(result.as_ref().unwrap_err().to_string().contains("proxy"), "error message mismatch");
}
...
async fn test_validation_max_concurrent_zero() {
    ...
    let engine = create_engine(Some(engine_config)).expect("handle creation should succeed");
    let url = format!("{}/fixtures/{}", std::env::var("MOCK_SERVER_URL").expect("MOCK_SERVER_URL not set"), "validation_max_concurrent_zero");
    let result = scrape(&engine, &url).await;
    assert!(result.is_err(), "expected call to fail");
    assert!(result.as_ref().unwrap_err().to_string().contains("max_concurrent"), "error message mismatch");
}
...
async fn test_validation_max_depth_too_high() {
    ...
    let engine = create_engine(Some(engine_config)).expect("handle creation should succeed");
    let url = format!("{}/fixtures/{}", std::env::var("MOCK_SERVER_URL").expect("MOCK_SERVER_URL not set"), "validation_max_depth_too_high");
    let result = scrape(&engine, &url).await;
    assert!(result.is_err(), "expected call to fail");
    assert!(result.as_ref().unwrap_err().to_string().contains("max_depth"), "error message mismatch");
}
...
async fn test_validation_negative_body_size() {
    ...
    let engine = create_engine(Some(engine_config)).expect("handle creation should succeed");
    let url = format!("{}/fixtures/{}", std::env::var("MOCK_SERVER_URL").expect("MOCK_SERVER_URL not set"), "validation_negative_body_size");
    let result = scrape(&engine, &url).await;
    assert!(result.is_err(), "expected call to fail");
    assert!(result.as_ref().unwrap_err().to_string().contains("body_size"), "error message mismatch");
}
