...
// alef:hash:ada5536ff29082ff089d42d42e4132d6b6a88371ff10855c9aed8521848cbbbd
...
async fn test_validation_empty_batch_urls() {
    ...
    assert!(
        result.as_ref().err().unwrap().to_string().contains("urls"),
...
async fn test_validation_invalid_auth_config() {
    ...
    assert!(result.is_err(), "expected call to fail");
    assert!(
        result.as_ref().err().unwrap().to_string().contains("auth"),
        "error message mismatch"
    );
}
...
async fn test_validation_invalid_exclude_regex() {
    ...
    assert!(result.is_err(), "expected call to fail");
    assert!(
        result.as_ref().err().unwrap().to_string().contains("exclude_path"),
        "error message mismatch"
    );
}
...
async fn test_validation_invalid_include_regex() {
    ...
    assert!(result.is_err(), "expected call to fail");
    assert!(
        result.as_ref().err().unwrap().to_string().contains("include_path"),
        "error message mismatch"
    );
}
...
async fn test_validation_invalid_proxy_url() {
    ...
    assert!(result.is_err(), "expected call to fail");
    assert!(
        result.as_ref().err().unwrap().to_string().contains("proxy"),
        "error message mismatch"
    );
}
...
async fn test_validation_invalid_retry_code() {
    ...
    assert!(result.is_err(), "expected call to fail");
    assert!(
        result.as_ref().err().unwrap().to_string().contains("retry code"),
        "error message mismatch"
    );
}
...
async fn test_validation_max_concurrent_zero() {
    ...
    assert!(result.is_err(), "expected call to fail");
    assert!(
        result.as_ref().err().unwrap().to_string().contains("max_concurrent"),
        "error message mismatch"
    );
}
...
async fn test_validation_max_depth_too_high() {
    ...
    assert!(result.is_err(), "expected call to fail");
    assert!(
        result.as_ref().err().unwrap().to_string().contains("max_depth"),
        "error message mismatch"
    );
}
...
async fn test_validation_max_pages_zero() {
    ...
    assert!(result.is_err(), "expected call to fail");
    assert!(
        result.as_ref().err().unwrap().to_string().contains("max_pages"),
        "error message mismatch"
    );
}
...
async fn test_validation_max_redirects_too_high() {
    ...
    assert!(result.is_err(), "expected call to fail");
    assert!(
        result.as_ref().err().unwrap().to_string().contains("max_redirects"),
        "error message mismatch"
    );
}
...
async fn test_validation_negative_body_size() {
    ...
    assert!(result.is_err(), "expected call to fail");
    assert!(
        result.as_ref().err().unwrap().to_string().contains("body_size"),
        "error message mismatch"
    );
}
...
async fn test_validation_timeout_zero() {
    ...
    assert!(result.is_err(), "expected call to fail");
    assert!(
        result.as_ref().err().unwrap().to_string().contains("request_timeout"),
        "error message mismatch"
    );
}
