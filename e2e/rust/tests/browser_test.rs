...
async fn test_browser_config_auto_no_feature() {
    ...
    let engine_config: CrawlConfig = serde_json::from_str("{\"browser\":{\"mode\":\"auto\"}}").expect("config should parse");
...
async fn test_browser_crawl_mode_always() {
    ...
    let engine = create_engine(Some(engine_config)).expect("handle creation should succeed");
    let url = format!("{}/fixtures/{}", std::env::var("MOCK_SERVER_URL").expect("MOCK_SERVER_URL not set"), "browser_crawl_mode_always");
...
async fn test_browser_crawl_waf_fallback() {
    ...
    let engine = create_engine(Some(engine_config)).expect("handle creation should succeed");
    let url = format!("{}/fixtures/{}", std::env::var("MOCK_SERVER_URL").expect("MOCK_SERVER_URL not set"), "browser_crawl_waf_fallback");
    let _ = scrape(&engine, &url).await.expect("should succeed");
    // skipped: field 'pages.length' not available on result type
}
...
async fn test_browser_endpoint_invalid() {
    ...
    let engine = create_engine(Some(engine_config)).expect("handle creation should succeed");
    let url = format!("{}/fixtures/{}", std::env::var("MOCK_SERVER_URL").expect("MOCK_SERVER_URL not set"), "browser_endpoint_invalid");
    let result = scrape(&engine, &url).await;
    assert!(result.is_err(), "expected call to fail");
    assert!(result.as_ref().unwrap_err().to_string().contains("endpoint"), "error message mismatch");
}
...
async fn test_browser_extra_wait() {
    ...
    let engine = create_engine(Some(engine_config)).expect("handle creation should succeed");
    let url = format!("{}/fixtures/{}", std::env::var("MOCK_SERVER_URL").expect("MOCK_SERVER_URL not set"), "browser_extra_wait");
    let _ = scrape(&engine, &url).await.expect("should succeed");
    // skipped: field 'browser.browser_used' not available on result type
}
...
async fn test_browser_profile_basic() {
    ...
    let engine = create_engine(Some(engine_config)).expect("handle creation should succeed");
    let url = format!("{}/fixtures/{}", std::env::var("MOCK_SERVER_URL").expect("MOCK_SERVER_URL not set"), "browser_profile_basic");
    let result = scrape(&engine, &url).await.expect("should succeed");
    // skipped: field 'browser.browser_used' not available on result type
    assert_eq!(result.status_code, 200, "equals assertion failed");
}
...
async fn test_browser_wait_fixed() {
    ...
    let engine = create_engine(Some(engine_config)).expect("handle creation should succeed");
    let url = format!("{}/fixtures/{}", std::env::var("MOCK_SERVER_URL").expect("MOCK_SERVER_URL not set"), "browser_wait_fixed");
    let result = scrape(&engine, &url).await.expect("should succeed");
    // skipped: field 'browser.browser_used' not available on result type
    assert_eq!(result.status_code, 200, "equals assertion failed");
}
...
async fn test_browser_wait_selector() {
    ...
    let engine = create_engine(Some(engine_config)).expect("handle creation should succeed");
    let url = format!("{}/fixtures/{}", std::env::var("MOCK_SERVER_URL").expect("MOCK_SERVER_URL not set"), "browser_wait_selector");
    let result = scrape(&engine, &url).await.expect("should succeed");
    // skipped: field 'browser.browser_used' not available on result type
    assert_eq!(result.status_code, 200, "equals assertion failed");
}
