...
# alef:hash:95c3f412a4f82abeb2fc1c651ce1d976ef9df1d991f55c59470c016ca7009abb
...
RSpec.describe 'validation' do
  it 'validation_empty_batch_urls: batch operation with empty batch_urls array is rejected' do
    ...
    expect { Kreuzcrawl.batch_scrape_async(engine, []) }.to raise_error
  end
  ...
  it 'validation_invalid_auth_config: auth object with empty username in basic auth is rejected' do
    ...
    expect { Kreuzcrawl.scrape_async(engine, url) }.to raise_error
  end
