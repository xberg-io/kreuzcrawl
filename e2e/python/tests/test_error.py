...
# alef:hash:1c428f98057aef9dee8a2ee6d0a6649f275bab6e4ac9d309918180a2277e8ba4
...
async def test_error_browser_launch_failure() -> None:
    ...
    with pytest.raises(Exception):  # noqa: B017
        engine_config = CrawlConfig(
            browser=BrowserConfig(mode="always"), browser_launch_timeout_ms=1
        )
...
async def test_error_browser_page_timeout() -> None:
    ...
    with pytest.raises(Exception):  # noqa: B017
        engine_config = CrawlConfig(
            browser=BrowserConfig(mode="always"), page_load_timeout_ms=1
        )
        engine = create_engine(engine_config)
...
async def test_error_empty_response() -> None:
    ...
    assert result.is_error is False  # noqa: S101
