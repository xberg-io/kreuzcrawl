...
# alef:hash:f03786839ce9c76d53b66dfde69d4fb9ca48c824126e402c6ee8817e99e2ff7c
...
async def test_error_browser_launch_failure() -> None:
    ...
    with pytest.raises(Exception):  # noqa: B017
        engine_config = CrawlConfig(browser=BrowserConfig(mode="always"), browser_launch_timeout_ms=1)
        engine = create_engine(engine_config)
...
async def test_error_browser_page_timeout() -> None:
    ...
    with pytest.raises(Exception):  # noqa: B017
        engine_config = CrawlConfig(browser=BrowserConfig(mode="always"), page_load_timeout_ms=1)
        engine = create_engine(engine_config)
