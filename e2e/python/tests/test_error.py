...
# alef:hash:4833e844c7a01476c31aac39e067d263b8850f816763ea7890ab34e6f233d467
...
async def test_error_invalid_proxy() -> None:
    ...
    engine_config = CrawlConfig(
        proxy=ProxyConfig(url="http://127.0.0.1:1"), request_timeout=2
    )
    engine = create_engine(engine_config)
...
async def test_error_retry_503() -> None:
    ...
    engine_config = CrawlConfig(
        respect_robots_txt=False, retry_codes=[503], retry_count=2
    )
    engine = create_engine(engine_config)
...
async def test_error_retry_backoff() -> None:
    ...
    engine_config = CrawlConfig(
        respect_robots_txt=False, retry_codes=[429], retry_count=3
    )
    engine = create_engine(engine_config)
