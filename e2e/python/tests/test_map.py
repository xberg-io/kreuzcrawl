...
# alef:hash:d377c0ff49d3f9d5ed2b4e10b15f2e57c0b6ca2933b18ff177c6f2520bd4f21a
...
async def test_map_include_subdomains() -> None:
    ...
    assert "blog.example.com" in result.urls  # noqa: S101
...
async def test_map_search_filter() -> None:
    ...
    result = await map_urls(engine, url)
    assert len(result.urls) >= 2  # noqa: S101
    assert "blog" in result.urls  # noqa: S101
