...
# alef:hash:980e549efdc74b063e30a7077b84a281d5ebe5d092eae421248e1c09db3a3cc7
...
async def test_interact_invalid_selector() -> None:
    ...
    assert "not found" in str(result.action_results[0].error).lower()  # noqa: S101
...
async def test_interact_screenshot() -> None:
    ...
    actions = [PageAction(full_page=False, selector="#target", type="screenshot")]
