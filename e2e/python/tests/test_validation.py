...
# alef:hash:9e9ea3d4c77f6a1f7a3f795f8f886cfffab6a77c763bf89972b7fd21ced2c632
...
async def test_validation_empty_batch_urls() -> None:
    ...
    assert "urls" in type(exc_info.value).__name__  # noqa: S101
...
async def test_validation_invalid_auth_config() -> None:
    ...
    with pytest.raises(Exception) as exc_info:  # noqa: B017
        await scrape(engine, url)
    assert "auth" in type(exc_info.value).__name__  # noqa: S101
...
async def test_validation_invalid_exclude_regex() -> None:
    ...
    with pytest.raises(Exception) as exc_info:  # noqa: B017
        await scrape(engine, url)
    assert "exclude_path" in type(exc_info.value).__name__  # noqa: S101
...
async def test_validation_invalid_include_regex() -> None:
    ...
    with pytest.raises(Exception) as exc_info:  # noqa: B017
        await scrape(engine, url)
    assert "include_path" in type(exc_info.value).__name__  # noqa: S101
...
async def test_validation_invalid_proxy_url() -> None:
    ...
    with pytest.raises(Exception) as exc_info:  # noqa: B017
        await scrape(engine, url)
    assert "proxy" in type(exc_info.value).__name__  # noqa: S101
...
async def test_validation_invalid_retry_code() -> None:
    ...
    with pytest.raises(Exception) as exc_info:  # noqa: B017
        await scrape(engine, url)
    assert "retry code" in type(exc_info.value).__name__  # noqa: S101
...
async def test_validation_max_concurrent_zero() -> None:
    ...
    with pytest.raises(Exception) as exc_info:  # noqa: B017
        await scrape(engine, url)
    assert "max_concurrent" in type(exc_info.value).__name__  # noqa: S101
...
async def test_validation_max_depth_too_high() -> None:
    ...
    with pytest.raises(Exception) as exc_info:  # noqa: B017
        await scrape(engine, url)
    assert "max_depth" in type(exc_info.value).__name__  # noqa: S101
...
async def test_validation_max_pages_zero() -> None:
    ...
    with pytest.raises(Exception) as exc_info:  # noqa: B017
        await scrape(engine, url)
    assert "max_pages" in type(exc_info.value).__name__  # noqa: S101
...
async def test_validation_max_redirects_too_high() -> None:
    ...
    with pytest.raises(Exception) as exc_info:  # noqa: B017
        await scrape(engine, url)
    assert "max_redirects" in type(exc_info.value).__name__  # noqa: S101
...
async def test_validation_negative_body_size() -> None:
    ...
    with pytest.raises(Exception) as exc_info:  # noqa: B017
        await scrape(engine, url)
    assert "body_size" in type(exc_info.value).__name__  # noqa: S101
...
async def test_validation_timeout_zero() -> None:
    ...
    with pytest.raises(Exception) as exc_info:  # noqa: B017
        await scrape(engine, url)
    assert "request_timeout" in type(exc_info.value).__name__  # noqa: S101
