...
# alef:hash:229cf1b95df23ed549506ae48690a93dc8269e7a8281041d09151e38a5687283
...
from kreuzcrawl import batch_scrape, scrape, create_engine, CrawlConfig, ProxyConfig
...
async def test_validation_empty_batch_urls() -> None:
    ...
    assert "urls" in str(exc_info.value)  # noqa: S101
...
async def test_validation_invalid_auth_config() -> None:
    ...
    assert "auth" in str(exc_info.value)  # noqa: S101
...
async def test_validation_invalid_proxy_url() -> None:
    ...
    with pytest.raises(Exception) as exc_info:  # noqa: B017
        ...
        await scrape(engine, url)
    assert "proxy" in str(exc_info.value)  # noqa: S101
...
async def test_validation_max_concurrent_zero() -> None:
    ...
    with pytest.raises(Exception) as exc_info:  # noqa: B017
        ...
        await scrape(engine, url)
    assert "max_concurrent" in str(exc_info.value)  # noqa: S101
...
async def test_validation_max_depth_too_high() -> None:
    ...
    with pytest.raises(Exception) as exc_info:  # noqa: B017
        ...
        await scrape(engine, url)
    assert "max_depth" in str(exc_info.value)  # noqa: S101
...
async def test_validation_negative_body_size() -> None:
    ...
    with pytest.raises(Exception) as exc_info:  # noqa: B017
        ...
        await scrape(engine, url)
    assert "body_size" in str(exc_info.value)  # noqa: S101
