...
# alef:hash:64ae77fd3ffe6931f685c15b2456695645c08d19f50ef1b139de9c3250f293a8
...
async def test_browser_config_auto_no_feature() -> None:
    ...
    assert result.browser.js_render_hint is True  # noqa: S101
    assert result.browser.browser_used is False  # noqa: S101
...
async def test_browser_detect_minimal_page() -> None:
    ...
    result = await scrape(engine, url)
    assert result.status_code == 200  # noqa: S101
    assert result.browser.js_render_hint is False  # noqa: S101
    assert result.browser.browser_used is False  # noqa: S101
...
async def test_browser_extra_wait() -> None:
    ...
    result = await scrape(engine, url)
    assert result.browser.browser_used is True  # noqa: S101
