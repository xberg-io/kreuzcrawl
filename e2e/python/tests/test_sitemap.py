...
# alef:hash:fd817ac29dbbf7dfc8f74f5ffc5c2cba395d8efb4fe832ee54ea144cbb1dd01f
...
async def test_sitemap_basic() -> None:
    ...
    assert result.has_lastmod is True  # noqa: S101
...
async def test_sitemap_xhtml_links() -> None:
    ...
    assert result.has_lastmod is False  # noqa: S101
