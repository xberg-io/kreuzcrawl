...
# alef:hash:be05251e5413aee7f3a43e94ba36d92a3c6ee437c6d7587b3a71959989ecdc10
...
test_encoding_double_encoded() {
    ...
    local output
    output=$(kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/encoding_double_encoded" --format json --browser-mode never)
...
test_encoding_mixed_charset_page() {
    ...
    local output
    output=$(kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/encoding_mixed_charset_page" --format json --browser-mode never)
...
test_encoding_percent_encoded_path() {
    ...
    local output
    output=$(kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/encoding_percent_encoded_path" --format json --browser-mode never)
...
test_encoding_unicode_url() {
    ...
    local output
    output=$(kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/encoding_unicode_url" --format json --browser-mode never)
