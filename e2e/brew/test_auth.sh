...
# alef:hash:bb7f7bbb3533fd205e870d434d139964e9467661546efdb1e818718c6db8d7be
...
test_auth_basic_http() {
    ...
    local output
    output=$(kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/auth_basic_http" --format json --browser-mode never)
...
test_auth_bearer_token() {
    ...
    local output
    output=$(kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/auth_bearer_token" --format json --browser-mode never)
...
test_auth_custom_header() {
    ...
    local output
    output=$(kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/auth_custom_header" --format json --browser-mode never)
