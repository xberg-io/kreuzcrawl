...
# alef:hash:1c5d4e25661d1992e0eeb0ab942cc7c150f00d8fe41b8302983cec144c31a825
...
test_robots_allow_all() {
    ...
    local output
    output=$(kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/robots_allow_all" --format json --browser-mode never)
...
test_robots_allow_override() {
    ...
    local output
    output=$(kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/robots_allow_override" --format json --browser-mode never)
...
test_robots_comments_handling() {
    ...
    local output
    output=$(kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/robots_comments_handling" --format json --browser-mode never)
...
test_robots_crawl_delay() {
    ...
    local output
    output=$(kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/robots_crawl_delay" --format json --browser-mode never)
...
test_robots_disallow_path() {
    ...
    local output
    output=$(kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/robots_disallow_path" --format json --browser-mode never)
...
test_robots_meta_nofollow() {
    ...
    local output
    output=$(kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/robots_meta_nofollow" --format json --browser-mode never)
...
test_robots_meta_noindex() {
    ...
    local output
    output=$(kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/robots_meta_noindex" --format json --browser-mode never)
...
test_robots_missing_404() {
    ...
    local output
    output=$(kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/robots_missing_404" --format json --browser-mode never)
...
test_robots_multiple_user_agents() {
    ...
    local output
    output=$(kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/robots_multiple_user_agents" --format json --browser-mode never)
...
test_robots_request_rate() {
    ...
    local output
    output=$(kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/robots_request_rate" --format json --browser-mode never)
...
test_robots_sitemap_directive() {
    ...
    local output
    output=$(kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/robots_sitemap_directive" --format json --browser-mode never)
...
test_robots_user_agent_specific() {
    ...
    local output
    output=$(kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/robots_user_agent_specific" --format json --browser-mode never)
...
test_robots_wildcard_paths() {
    ...
    local output
    output=$(kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/robots_wildcard_paths" --format json --browser-mode never)
...
test_robots_x_robots_tag() {
    ...
    local output
    output=$(kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/robots_x_robots_tag" --format json --browser-mode never)
