...
# alef:hash:a012925026ea6d43dd6c32af63110f9e27c5e55920984fd3d4bb6b5da3df58ad
...
test_stealth_ua_rotation_round_robin() {
  ...
  local output
  output=$(kreuzcrawl scrape "${MOCK_SERVER_STEALTH_UA_ROTATION_ROUND_ROBIN:-${MOCK_SERVER_URL}/fixtures/stealth_ua_rotation_round_robin}" --config '{"max_depth":1,"max_pages":3,"user_agents":["Mozilla/5.0 (Windows NT 10.0; Win64; x64) TestAgent-1","Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15) TestAgent-2"]}' --format json --browser-mode never)
