...
# alef:hash:be735a1b143ea5195d280f6a3dfadbc6b79e3463974101beb145a3cf6b6438f4
...
test_links_anchor_fragment() {
    ...
    local output
    output=$(kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/links_anchor_fragment" --format json --browser-mode never)
...
test_links_base_tag() {
    ...
    local output
    output=$(kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/links_base_tag" --format json --browser-mode never)
...
test_links_document_types() {
    ...
    local output
    output=$(kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/links_document_types" --format json --browser-mode never)
...
test_links_empty_href() {
    ...
    local output
    output=$(kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/links_empty_href" --format json --browser-mode never)
...
test_links_internal_external_classification() {
    ...
    local output
    output=$(kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/links_internal_external_classification" --format json --browser-mode never)
...
test_links_mailto_javascript_skip() {
    ...
    local output
    output=$(kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/links_mailto_javascript_skip" --format json --browser-mode never)
...
test_links_protocol_relative() {
    ...
    local output
    output=$(kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/links_protocol_relative" --format json --browser-mode never)
...
test_links_rel_attributes() {
    ...
    local output
    output=$(kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/links_rel_attributes" --format json --browser-mode never)
...
test_links_relative_parent() {
    ...
    local output
    output=$(kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/links_relative_parent" --format json --browser-mode never)
