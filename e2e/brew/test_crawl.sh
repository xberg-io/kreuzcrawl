...
# alef:hash:fd1aa07d7663558ff9ca9bc4ae5600a03f3b5bc96828915be0317822a719782d
...
test_content_binary_skip() {
    ...
    local output
    output=$(kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/content_binary_skip" --format json --browser-mode never)
...
test_content_pdf_link_skip() {
    ...
    local output
    output=$(kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/content_pdf_link_skip" --format json --browser-mode never)
...
test_crawl_concurrent_depth() {
    ...
    kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/crawl_concurrent_depth" --format json --browser-mode never >/dev/null
...
test_crawl_concurrent_limit() {
    ...
    kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/crawl_concurrent_limit" --format json --browser-mode never >/dev/null
...
test_crawl_concurrent_max_pages() {
    ...
    kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/crawl_concurrent_max_pages" --format json --browser-mode never >/dev/null
...
test_crawl_custom_headers() {
    ...
    kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/crawl_custom_headers" --format json --browser-mode never >/dev/null
...
test_crawl_depth_one() {
    ...
    kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/crawl_depth_one" --format json --browser-mode never >/dev/null
...
test_crawl_depth_priority() {
    ...
    kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/crawl_depth_priority" --format json --browser-mode never >/dev/null
...
test_crawl_depth_two() {
    ...
    kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/crawl_depth_two" --format json --browser-mode never >/dev/null
...
test_crawl_depth_two_chain() {
    ...
    kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/crawl_depth_two_chain" --format json --browser-mode never >/dev/null
...
test_crawl_double_slash_normalization() {
    ...
    kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/crawl_double_slash_normalization" --format json --browser-mode never >/dev/null
...
test_crawl_empty_page_no_links() {
    ...
    kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/crawl_empty_page_no_links" --format json --browser-mode never >/dev/null
...
test_crawl_exclude_path_pattern() {
    ...
    kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/crawl_exclude_path_pattern" --format json --browser-mode never >/dev/null
...
test_crawl_external_links_ignored() {
    ...
    kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/crawl_external_links_ignored" --format json --browser-mode never >/dev/null
...
test_crawl_fragment_stripping() {
    ...
    kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/crawl_fragment_stripping" --format json --browser-mode never >/dev/null
...
test_crawl_include_path_pattern() {
    ...
    kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/crawl_include_path_pattern" --format json --browser-mode never >/dev/null
...
test_crawl_max_depth_zero() {
    ...
    kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/crawl_max_depth_zero" --format json --browser-mode never >/dev/null
...
test_crawl_max_pages() {
    ...
    kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/crawl_max_pages" --format json --browser-mode never >/dev/null
...
test_crawl_mixed_content_types() {
    ...
    kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/crawl_mixed_content_types" --format json --browser-mode never >/dev/null
...
test_crawl_multiple_redirects_in_traversal() {
    ...
    kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/crawl_multiple_redirects_in_traversal" --format json --browser-mode never >/dev/null
...
test_crawl_query_param_dedup() {
    ...
    kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/crawl_query_param_dedup" --format json --browser-mode never >/dev/null
...
test_crawl_redirect_in_traversal() {
    ...
    kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/crawl_redirect_in_traversal" --format json --browser-mode never >/dev/null
...
test_crawl_self_link_no_loop() {
    ...
    kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/crawl_self_link_no_loop" --format json --browser-mode never >/dev/null
...
test_crawl_single_page_no_links() {
    ...
    kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/crawl_single_page_no_links" --format json --browser-mode never >/dev/null
...
test_crawl_stay_on_domain() {
    ...
    kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/crawl_stay_on_domain" --format json --browser-mode never >/dev/null
...
test_crawl_subdomain_exclusion() {
    ...
    kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/crawl_subdomain_exclusion" --format json --browser-mode never >/dev/null
...
test_crawl_subdomain_inclusion() {
    ...
    kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/crawl_subdomain_inclusion" --format json --browser-mode never >/dev/null
...
test_crawl_trailing_slash_dedup() {
    ...
    kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/crawl_trailing_slash_dedup" --format json --browser-mode never >/dev/null
...
test_crawl_url_deduplication() {
    ...
    kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/crawl_url_deduplication" --format json --browser-mode never >/dev/null
