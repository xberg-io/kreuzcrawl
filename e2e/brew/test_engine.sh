...
# alef:hash:689513d147684c089cc105d5524dd139c9b6f9b931fc63c1b91b1c4556a746d2
...
test_engine_batch_basic() {
    ...
    kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/engine_batch_basic" --format json --browser-mode never >/dev/null
...
test_engine_crawl_basic() {
    ...
    kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/engine_crawl_basic" --format json --browser-mode never >/dev/null
...
test_engine_map_basic() {
    ...
    kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/engine_map_basic" --format json --browser-mode never >/dev/null
...
test_engine_scrape_basic() {
    ...
    local output
    output=$(kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/engine_scrape_basic" --format json --browser-mode never)
...
test_engine_stream_basic() {
    ...
    kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/engine_stream_basic" --format json --browser-mode never >/dev/null
