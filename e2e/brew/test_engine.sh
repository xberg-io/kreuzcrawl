...
# alef:hash:ca78297d9d4002e769c89a09a95a6d3a9fbd40e4e3964b2022da6a858363b1e7
...
test_engine_crawl_basic() {
  ...
  local output
  output=$(kreuzcrawl crawl "${MOCK_SERVER_ENGINE_CRAWL_BASIC:-${MOCK_SERVER_URL}/fixtures/engine_crawl_basic}" --config '{"max_depth":1}' --format json --browser-mode never)
