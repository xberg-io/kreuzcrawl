...
# alef:hash:2d12dc86f89a7a0a53dd2ba7a090e3e4a3e334ec7ecd11ce09dd9e0d9b4ecec5
...
test_engine_crawl_basic() {
  ...
  local output
  output=$(kreuzcrawl scrape "${MOCK_SERVER_ENGINE_CRAWL_BASIC:-${MOCK_SERVER_URL}/fixtures/engine_crawl_basic}" --config '{"max_depth":1}' --format json --browser-mode never)
