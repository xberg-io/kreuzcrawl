...
# alef:hash:b7ffe5b5973f7529f695dcbf687e9838cf9eea42d1446079d80e1a72c9313776
...
test_metadata_article_times() {
    ...
    local output
    output=$(kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/metadata_article_times" --format json --browser-mode never)
...
test_metadata_favicons() {
    ...
    local output
    output=$(kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/metadata_favicons" --format json --browser-mode never)
...
test_metadata_headings() {
    ...
    local output
    output=$(kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/metadata_headings" --format json --browser-mode never)
...
test_metadata_hreflang() {
    ...
    local output
    output=$(kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/metadata_hreflang" --format json --browser-mode never)
...
test_metadata_keywords_author() {
    ...
    local output
    output=$(kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/metadata_keywords_author" --format json --browser-mode never)
...
test_metadata_og_video_audio() {
    ...
    local output
    output=$(kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/metadata_og_video_audio" --format json --browser-mode never)
...
test_metadata_response_headers() {
    ...
    local output
    output=$(kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/metadata_response_headers" --format json --browser-mode never)
...
test_metadata_word_count() {
    ...
    local output
    output=$(kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/metadata_word_count" --format json --browser-mode never)
