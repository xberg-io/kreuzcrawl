...
# alef:hash:2e33f59d99cfbafcbd8a6dd2479ffd4a9752c4f13292a9b93d0f1731a711cf89
...
test_batch_crawl_basic() {
    ...
    kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/batch_crawl_basic" --format json --browser-mode never >/dev/null
...
test_batch_crawl_partial_failure() {
    ...
    kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/batch_crawl_partial_failure" --format json --browser-mode never >/dev/null
...
test_batch_crawl_with_config() {
    ...
    kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/batch_crawl_with_config" --format json --browser-mode never >/dev/null
...
test_batch_scrape_empty_urls_error() {
    ...
    if kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/batch_scrape_empty_urls_error" --format json --browser-mode never >/dev/null 2>&1; then
...
test_batch_scrape_with_config() {
    ...
    kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/batch_scrape_with_config" --format json --browser-mode never >/dev/null
...
test_scrape_batch_basic() {
    ...
    kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/scrape_batch_basic" --format json --browser-mode never >/dev/null
...
test_scrape_batch_partial_failure() {
    ...
    kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/scrape_batch_partial_failure" --format json --browser-mode never >/dev/null
...
test_scrape_batch_progress() {
    ...
    kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/scrape_batch_progress" --format json --browser-mode never >/dev/null
