...
# alef:hash:a8663f1153e27ad1e693e6cbc31188c2594b9d4a9ff17232231995d8775dc59b
...
test_browser_config_auto_no_feature() {
    ...
    local output
    output=$(kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/browser_config_auto_no_feature" --format json --browser-mode never)
...
test_browser_config_never_mode() {
    ...
    local output
    output=$(kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/browser_config_never_mode" --format json --browser-mode never)
...
test_browser_crawl_mode_always() {
    ...
    kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/browser_crawl_mode_always" --format json --browser-mode never >/dev/null
...
test_browser_crawl_waf_fallback() {
    ...
    kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/browser_crawl_waf_fallback" --format json --browser-mode never >/dev/null
...
test_browser_detect_minimal_page() {
    ...
    local output
    output=$(kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/browser_detect_minimal_page" --format json --browser-mode never)
...
test_browser_detect_next_empty() {
    ...
    local output
    output=$(kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/browser_detect_next_empty" --format json --browser-mode never)
...
test_browser_detect_next_rendered() {
    ...
    local output
    output=$(kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/browser_detect_next_rendered" --format json --browser-mode never)
...
test_browser_detect_normal_page() {
    ...
    local output
    output=$(kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/browser_detect_normal_page" --format json --browser-mode never)
...
test_browser_detect_nuxt_shell() {
    ...
    local output
    output=$(kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/browser_detect_nuxt_shell" --format json --browser-mode never)
...
test_browser_detect_react_shell() {
    ...
    local output
    output=$(kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/browser_detect_react_shell" --format json --browser-mode never)
...
test_browser_detect_vue_shell() {
    ...
    local output
    output=$(kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/browser_detect_vue_shell" --format json --browser-mode never)
...
test_browser_endpoint_invalid() {
    ...
    if kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/browser_endpoint_invalid" --format json --browser-mode never >/dev/null 2>&1; then
...
test_browser_extra_wait() {
    ...
    kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/browser_extra_wait" --format json --browser-mode never >/dev/null
...
test_browser_fallback_spa_render() {
    ...
    kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/browser_fallback_spa_render" --format json --browser-mode never >/dev/null
...
test_browser_fallback_waf_blocked() {
    ...
    kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/browser_fallback_waf_blocked" --format json --browser-mode never >/dev/null
...
test_browser_mode_always() {
    ...
    kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/browser_mode_always" --format json --browser-mode never >/dev/null
...
test_browser_profile_basic() {
    ...
    local output
    output=$(kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/browser_profile_basic" --format json --browser-mode never)
...
test_browser_wait_fixed() {
    ...
    local output
    output=$(kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/browser_wait_fixed" --format json --browser-mode never)
...
test_browser_wait_selector() {
    ...
    local output
    output=$(kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/browser_wait_selector" --format json --browser-mode never)
