...
# alef:hash:4104507d582648a7becf796c212085b3c9935a3d101ea5d0d74607390472411f
...
test_markdown_crawl_all_pages() {
  ...
  local output
  output=$(kreuzcrawl scrape "${MOCK_SERVER_MARKDOWN_CRAWL_ALL_PAGES:-${MOCK_SERVER_URL}/fixtures/markdown_crawl_all_pages}" --config '{"max_depth":1}' --format json --browser-mode never)
