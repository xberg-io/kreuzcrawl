...
# alef:hash:0eb833a6b237df0e4f15ed3c601edd518e2f8b4cdacb7a5090d858067357ebe9
...
test_content_204_no_content() {
    ...
    local output
    output=$(kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/content_204_no_content" --format json --browser-mode never)
...
test_content_charset_iso8859() {
    ...
    local output
    output=$(kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/content_charset_iso8859" --format json --browser-mode never)
...
test_content_empty_body() {
    ...
    local output
    output=$(kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/content_empty_body" --format json --browser-mode never)
...
test_content_gzip_compressed() {
    ...
    local output
    output=$(kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/content_gzip_compressed" --format json --browser-mode never)
...
test_content_large_page_limit() {
    ...
    local output
    output=$(kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/content_large_page_limit" --format json --browser-mode never)
...
test_content_main_only() {
    ...
    kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/content_main_only" --format json --browser-mode never >/dev/null
...
test_content_pdf_no_extension() {
    ...
    local output
    output=$(kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/content_pdf_no_extension" --format json --browser-mode never)
...
test_content_remove_tags() {
    ...
    local output
    output=$(kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/content_remove_tags" --format json --browser-mode never)
...
test_content_utf8_bom() {
    ...
    local output
    output=$(kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/content_utf8_bom" --format json --browser-mode never)
