...
# alef:hash:9fb93711a816f190eef576d5e1ae4e7e24f7c46429ef355088b3386c1058c3c4
...
test_scrape_asset_dedup() {
    ...
    local output
    output=$(kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/scrape_asset_dedup" --format json --browser-mode never)
...
test_scrape_asset_max_size() {
    ...
    local output
    output=$(kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/scrape_asset_max_size" --format json --browser-mode never)
...
test_scrape_asset_type_filter() {
    ...
    local output
    output=$(kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/scrape_asset_type_filter" --format json --browser-mode never)
...
test_scrape_basic_html_page() {
    ...
    local output
    output=$(kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/scrape_basic_html_page" --format json --browser-mode never)
...
test_scrape_complex_links() {
    ...
    local output
    output=$(kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/scrape_complex_links" --format json --browser-mode never)
...
test_scrape_download_assets() {
    ...
    local output
    output=$(kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/scrape_download_assets" --format json --browser-mode never)
...
test_scrape_dublin_core() {
    ...
    local output
    output=$(kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/scrape_dublin_core" --format json --browser-mode never)
...
test_scrape_empty_page() {
    ...
    local output
    output=$(kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/scrape_empty_page" --format json --browser-mode never)
...
test_scrape_feed_discovery() {
    ...
    local output
    output=$(kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/scrape_feed_discovery" --format json --browser-mode never)
...
test_scrape_image_sources() {
    ...
    local output
    output=$(kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/scrape_image_sources" --format json --browser-mode never)
...
test_scrape_js_heavy_spa() {
    ...
    local output
    output=$(kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/scrape_js_heavy_spa" --format json --browser-mode never)
...
test_scrape_json_ld() {
    ...
    local output
    output=$(kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/scrape_json_ld" --format json --browser-mode never)
...
test_scrape_malformed_html() {
    ...
    local output
    output=$(kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/scrape_malformed_html" --format json --browser-mode never)
...
test_scrape_og_metadata() {
    ...
    local output
    output=$(kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/scrape_og_metadata" --format json --browser-mode never)
...
test_scrape_twitter_card() {
    ...
    local output
    output=$(kreuzcrawl scrape "${MOCK_SERVER_URL}/fixtures/scrape_twitter_card" --format json --browser-mode never)
