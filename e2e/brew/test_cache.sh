...
# alef:hash:40aa6f5759f5316e1d7d9e2dd1b49fd7698db5ef6d79bf69d642055d1664a6e2
...
test_cache_last_modified() {
  ...
  local output
  output=$(kreuzcrawl scrape "${MOCK_SERVER_CACHE_LAST_MODIFIED:-${MOCK_SERVER_URL}/fixtures/cache_last_modified}" --config '{"max_depth":1}' --format json --browser-mode never)
