...
- Source checkout used for vendoring: `/tmp/obscura`
- Source commit: `e371e942fc894578283b00690e34943fe1e45c7e`
- License: Apache License, Version 2.0
- License text: included below in this file
- NOTICE file in source checkout: none visible
...
- Disabled the upstream tracker domain blocklist because
  ...
  provenance or license header in the local checkout.

### Audit Notes

The implementation depends on `deno_core` / V8 through the vendored JS runtime.
Run the repository license audit before release and keep this file updated with
any additional attribution obligations.

Do not enable the vendored `stealth` feature until `wreq`, `boring2`, and
`boring-sys2` obligations are explicitly audited.
